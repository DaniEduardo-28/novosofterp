...
if ($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        ...
        Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('digemid/items', 'Tenant\ItemController@index')->name('tenant.digemid.items.index')->middleware('redirect.level');
            ...
            Route::get('items/export/digemid', 'Tenant\ItemController@exportDigemid')->name('tenant.items.export.digemid');
            ...
            Route::post('/uploads/analisis', 'Tenant\ItemController@uploadAnalisis');
            ...
            Route::post('documents/phone', 'Tenant\DocumentController@phone');
            ...
            Route::post('quotations/phone', 'Tenant\QuotationController@phone');
            ...
            Route::post('sale-notes/phone', 'Tenant\SaleNoteController@phone');
            ...
            Route::get('cash/report/products80/{cash}/{is_garage?}', 'Tenant\CashController@report_products_80');
            ...
            Route::get('digemid/item-sets', 'Tenant\ItemSetController@index')->name('tenant.digemid.item_sets.index')->middleware('redirect.level');
            ...
            Route::post('item-sets/duplicate', 'Tenant\ItemSetController@duplicate');
