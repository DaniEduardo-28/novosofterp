        ...
        <div class="form-body">
          <div class="row">
            ...
            <div class="col-lg-2">
              ...
              >
                <label class="control-label"
                  >Fecha de emisión<span class="text-danger"> *</span></label
                >
                <el-date-picker
            ...
            <div class="col-lg-2">
              <div
                :class="{ 'has-danger': errors.date_of_shipping }"
                class="form-group"
              >
                <label class="control-label"
                  >Fecha de traslado<span class="text-danger"> *</span></label
                >
                <el-date-picker
            ...
            <div class="col-lg-4">
              ...
              >
                <label class="control-label">
                  Cliente o Proveedor<span class="text-danger"> *</span>
            ...
            <div class="col-lg-2">
              <div
                :class="{ 'has-danger': errors.transport_mode_type_id }"
                class="form-group"
              >
                <label class="control-label"
                  >Modo de traslado<span class="text-danger"> *</span></label
                >
            ...
            <div class="col-lg-4">
              <div
                :class="{ 'has-danger': errors.transfer_reason_type_id }"
                class="form-group"
              >
                <label class="control-label"
                  >Motivo de traslado<span class="text-danger"> *</span></label
                >
                <el-select
            ...
            <template v-if="form.transfer_reason_type_id === '09'">
              <div class="col-lg-3">
                <div
                  :class="{ 'has-danger': errors['related.number'] }"
                  class="form-group"
                >
                  <label class="control-label"
              ...
              <div class="col-lg-3">
                <div
                  :class="{ 'has-danger': errors['related.document_type_id'] }"
                  class="form-group"
                >
                  <label class="control-label"
                    >Tipo documento relacionado<span class="text-danger">
                      *</span
                    ></label
                  >
            ...
            <div
              :class="
                form.transfer_reason_type_id === '09' ? 'col-lg-12' : 'col-lg-6'
              "
            >
              <div
                :class="{ 'has-danger': errors.transfer_reason_description }"
                class="form-group"
              >
                <label class="control-label"
          ...
          <div class="row">
            ...
            <div class="col-lg-2">
              ...
              >
                <label class="control-label"
                  >Peso total<span class="text-danger"> *</span></label
                >
                <el-input-number
            ...
            <div class="col-lg-2">
              <div
                :class="{ 'has-danger': errors.packages_number }"
                class="form-group"
              >
                <label class="control-label"
                  >Número de paquetes
            ...
            <div class="col-lg-2" v-if="!order_form_id">
              <div
                :class="{ 'has-danger': errors.order_form_external }"
                class="form-group"
              >
                <label class="control-label"
                  >Orden de pedido
          ...
          <div class="row">
            <div class="col-lg-12">
              <div
                :class="{ 'has-danger': errors.origin_address_id }"
                class="form-group"
              >
                <label class="control-label"
                  >Punto de partida<span class="text-danger"> *</span>
                  <a
                    href="#"
          ...
          <div class="row">
            <div class="col-lg-12">
              <div
                :class="{ 'has-danger': errors.delivery_address_id }"
                class="form-group"
              >
                <label class="control-label"
                  >Punto de llegada<span class="text-danger"> *</span>
                  <a
                    href="#"
          ...
          <div class="row">
            <template v-if="form.transport_mode_type_id === '01'">
              <div class="col-lg-6">
                ...
                <span class="text-danger"> *</span>
                <div
                  :class="{ 'has-danger': errors.dispatcher_id }"
                  class="form-group"
                >
                  <el-select
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(row, index) in form.items" :key="index">
                    ...
                    <td v-if="row.item && row.item.item.internal_id">
                      {{ row.item.item.internal_id }}
                    </td>
                    <td v-else>{{ row.internal_id }}</td>
                    <td>
                      <el-input
...
export default {
  ...
  async mounted() {
    ...
    if (this.parentId) {
      ...
      if (this.parentTable !== "dispatches") {
        this.setDefaults();
      } else if (this.parentTable !== "purchase") {
  ...
  if (error.response && error.response.status === 422) {
    ...
    async getOriginAddresses(establishment_id) {
      await this.$http
        .get(`/${this.resource}/get_origin_addresses/${establishment_id}`)
        .then((response) => {
