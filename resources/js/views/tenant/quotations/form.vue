<template>
    <div class="card mb-0 pt-2 pt-md-0">
        ...
        <quotation-form-item :showDialog.sync="showDialogAddItem" :configuration="config"
            :currency-type-id-active="form.currency_type_id" :exchange-rate-sale="form.exchange_rate_sale"
            :typeUser="typeUser" :recordItem="recordItem" :customer-id="form.customer_id"
            :percentage-igv="percentage_igv" :currency-types="currency_types" :show-option-change-currency="true"
