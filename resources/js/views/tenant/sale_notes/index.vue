    ...
    <div class="card mb-0">
      ...
      <div class="card-body">
        <data-table :resource="resource">
          <tr slot="heading">
            <th>#</th>
            <th class="text-right" v-if="columns.seller_name.visible">
              Vendedor
            </th>

            <th class="text-center">Fecha Emisión</th>
            <th class="text-center" v-if="columns.date_payment.visible">
              Fecha de pago
            </th>
            <th>Cliente</th>
            <th>Nota de Venta</th>
            <th>Estado</th>
            <th class="text-right" v-if="columns.exchange_rate_sale.visible">
              T.C.
            </th>
            ...
            <th class="text-right" v-if="columns.total_exportation.visible">
              T.Exportación
            </th>
            <th class="text-right" v-if="columns.total_free.visible">
              T.Gratuito
            </th>
            <th class="text-right" v-if="columns.total_unaffected.visible">
              T.Inafecta
            </th>
            <th class="text-right" v-if="columns.total_exonerated.visible">
              T.Exonerado
            </th>
            <th class="text-right" v-if="columns.total_taxed.visible">
              T.Gravado
            </th>
            <th class="text-right" v-if="columns.total_igv.visible">T.Igv</th>
            <th class="text-right">Total</th>

            <th class="text-center" v-if="columns.total_paid.visible">
              Pagado
            </th>
            <th class="text-center" v-if="columns.total_pending_paid.visible">
              Por pagar
            </th>
            ...
            <th class="text-center" v-if="typeUser == 'admin'">Pagos</th>
            <th class="text-center">Descarga</th>
            <th class="text-center" v-if="columns.recurrence.visible">
              Recurrencia
            </th>
            <td class="text-right" v-if="columns.region.visible">Region</td>
          ...
          <tr slot-scope="{ index, row }">
            <td>{{ index }}</td>
            <td class="text-right" v-if="columns.seller_name.visible">
              {{ row.seller_name }}
            </td>

            <td class="text-center">{{ row.date_of_issue }}</td>
            <td class="text-center" v-if="columns.date_payment.visible">
              {{ row.date_of_payment }}
            </td>
            <td>
            ...
            <td class="text-center" v-if="columns.exchange_rate_sale.visible">
            ...
            <td
              ...
              :class="{
                'text-danger':
                  row.total_pending_paid > 0 && isDateWarning(row.due_date),
              }"
              v-if="columns.due_date.visible"
            >
              {{ row.due_date }}
            </td>
            <td class="text-right" v-if="columns.total_exportation.visible">
              {{ row.total_exportation }}
            </td>
            <td class="text-right" v-if="columns.total_free.visible">
              {{ row.total_free }}
            </td>
            <td class="text-right" v-if="columns.total_unaffected.visible">
              {{ row.total_unaffected }}
            </td>
            <td class="text-right" v-if="columns.total_exonerated.visible">
              {{ row.total_exonerated }}
            </td>

            <td class="text-right" v-if="columns.total_taxed.visible">
              {{ row.total_taxed }}
            </td>
            ...
            <td class="text-center">
              ...
              <template v-else>
                <span
                  ...
                  >{{ row.total_canceled ? "Pagado" : "Pendiente" }}</span
                >
              </template>
            </td>
            ...
            <td class="text-center" v-if="typeUser == 'admin'">
              <button
                type="button"
            ...
            <td class="text-right" v-if="columns.dispatch_status.visible">
              <template v-if="row.status_dispatch === 'ENTREGADO'">
                <button
                  ...
                  @click.prevent="clickDispatchStatus(row.id, false)"
                >
                  {{ row.status_dispatch }}
                </button>
              </template>
              ...
              <template v-if="row.status_dispatch === 'PENDIENTE'">
                <button
                  ...
                  @click.prevent="clickDispatchStatus(row.id, true)"
                >
                  {{ row.status_dispatch }}
                </button>
              </template>
