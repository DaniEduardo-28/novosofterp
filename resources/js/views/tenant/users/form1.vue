                ...
                <div class="row">
                    ...
                    <div v-if="typeUser != 'integrator'" class="col-md-12">
                        ...
                        <div class="row" v-if="typeUser != 'integrator'">
                            ...
                            <div  class="col-md-4 mt-1">
                                <div class="form-comtrol">
                                    <el-checkbox v-model="form.is_descuento">
                                        Descuentos POS
                                    </el-checkbox>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div  class="col-md-12 mt-4">
                                <div class="form-comtrol">
                                    <label class="control-label">Listado de precios que puede utilizar el vendedor en el POS</label>
                                </div>
                            </div>
                            <div  class="col-md-12 mt-1">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        <tr v-for="(row, index) in form.permisosLt" :key="index">
                                                <td>
                                                    <el-select v-model="row.description">
                                                        <el-option v-for="option in itemUnitTypes" :key="option.description" :value="option.description" :label="option.description"></el-option>
                                                    </el-select>
                                                </td>
                                                <td class="series-table-actions text-center">
                                                    <button  type="button" class="btn waves-effect waves-light btn-xs btn-danger" @click.prevent="clickDeleteItemUnitType(index)">
                                                        <i class="fa fa-trash"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><a href="#" @click.prevent="clickAddItemUnitType" class="text-center font-weight-bold text-info">[+ Agregar]</a></td>
                                            </tr>
                                    </table>
                                </div>
                            </div>
...
export default {
    ...
    async created() {
        await this.$http.get(`/${this.resource}/tables`).then((response) => {
            ...
            this.itemUnitTypes = response.data.itemUnitTypes;
    ...
    methods: {
        ...
        clickDeleteItemUnitType(index)
        {
            this.form.permisosLt.splice(index, 1);
        },
