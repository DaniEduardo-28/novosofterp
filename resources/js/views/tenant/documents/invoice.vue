<template>
    <div>
        ...
        <document-form-item :configuration="config" :currency-type-id-active="form.currency_type_id"
            ...
            :is-from-invoice="true" :percentage-igv="percentage_igv" @add="addRow"></document-form-item>
        ...
        <document-options :configuration="config" :isContingency="is_contingency" :isUpdate="isUpdate"
            :recordId="documentNewId" :showClose="false" :showDialog.sync="showDialogOptions"></document-options>
