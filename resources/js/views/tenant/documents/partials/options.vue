  ...
  >
    ...
    <div v-loading="loading">
      ...
      <div class="row">
        ...
        <div v-if="ShowTicket80" class="col text-center font-weight-bold mt-3">
          <button
            class="btn btn-lg btn-info waves-effect waves-light"
            type="button"
        ...
        <div v-if="ShowTicket58" class="col text-center font-weight-bold mt-3">
          <button
            class="btn btn-lg btn-info waves-effect waves-light"
            type="button"
        ...
        <div v-if="ShowTicket50" class="col text-center font-weight-bold mt-3">
          <el-popover
            placement="top-start"
            :open-delay="1000"
            width="145"
