<template>
    <div>
            ...
            <form autocomplete="off" class="row no-gutters" @submit.prevent="submit">
                <div class="col-xl-9 col-md-9 col-12">
                    <div class="row card-header no-gutters align-items-start"
                        ...
                        <div class="col-xl-2 col-md-2 col-12">
                            <logo :path_logo="(company.logo != null) ? `/storage/uploads/logos/${company.logo}` : ''"
                                :position_class="'text-left'" url="/"></logo>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 align-self-end">
                                        <div :class="{ 'has-danger': errors.date_of_issue }" class="form-group">
                                            ...
                                            <el-date-picker v-model="form.date_of_issue" :clearable="false"
                                                :picker-options="datEmision" :readonly="readonly_date_of_due"
                                    ...
                                    <div class="col-lg-6 align-self-end">
                                        <div :class="{ 'has-danger': errors.date_of_due }" class="form-group">
                                            ...
                                            <el-date-picker v-model="form.date_of_due" :clearable="false"
                                                :readonly="readonly_date_of_due" type="date"
                    ...
                    <div class="card-body no-gutters">
                        <div class="row">
                            <div class="col-lg-4 align-self-end">
                                <div :class="{ 'has-danger': errors.document_type_id }" class="form-group">
                                    ...
                                    <el-select v-model="form.document_type_id"
                                        class="border-left rounded-left border-info" dusk="document_type_id"
                            ...
                            <div class="col-lg-2 d-none">
                                <div :class="{ 'has-danger': errors.establishment_id }" class="form-group">
                                    ...
                                    <small v-if="errors.establishment_id" class="form-control-feedback"
                                ...
                                <div :class="{ 'has-danger': errors.series_id }" class="form-group">
                                    ...
                                    <el-select v-model="form.series_id" :disabled="disabledSeries()">
                                        <el-option v-for="option in series" :key="option.id" :label="option.number"
                                            :disabled="option.disabled" :value="option.id"></el-option>
                                    </el-select>
                            ...
                            <div class="col-lg-2 align-self-end">
                                <div :class="{ 'has-danger': errors.operation_type_id }" class="form-group">
                                    ...
                                    <el-select v-model="form.operation_type_id" @change="changeOperationType">
                                        <el-option v-for="option in operation_types" :key="option.id"
                                            :label="option.description" :value="option.id"></el-option>
                                    </el-select>
                                    <small v-if="errors.operation_type_id" class="form-control-feedback"
                            ...
                            <div class="col-lg-2 align-self-end">
                                <div :class="{ 'has-danger': errors.exchange_rate_sale }" class="form-group">
                                    <label class="control-label">Tipo de cambio
                                        <el-tooltip class="item" content="Tipo de cambio del día, extraído de SUNAT"
                    ...
                    <div class="card-body border-top no-gutters">
                        <div class="row">
                            <div :class="{ 'has-danger': errors.customer_id }" class="form-group col-sm-6 mb-0">
                                ...
                                <el-select v-model="form.customer_id" :loading="loading_search"
                                    ...
                                    dusk="customer_id" filterable @focus="focus_on_client = true"
                            ...
                            <!-- sistema por puntos -->
                            <div v-if="config.enabled_point_system && form.customer_id"
                                ...
                                <p class="fs-point-system">
                                    ...
                                    <template v-if="total_exchange_points > 0">
                                        - <b style="color:red">{{ total_exchange_points }}</b> = <b>{{
                                            calculate_customer_accumulated_points }}</b>
                                    </template>
                                </p>
                                <p class="fs-point-system">
                    ...
                    <div class="card-body border-top no-gutters p-0">
                                ...
                                <tbody>
                                    <tr v-for="(row, index) in form.items" :key="index">
                                        ...
                                        <td>{{ setDescriptionOfItem(row.item) }}
                                            ...
                                            <!-- sistema por puntos -->
                                            <template
                                                v-if="config.enabled_point_system && customer_accumulated_points > 0 && row.item.exchange_points">
                                                <el-checkbox class="mt-2 mb-2" v-model="row.item.exchanged_for_points"
                                                    @change="changeRowExchangePoints(row, index)"><b>{{
                                                        getExchangePointDescription(row) }}</b></el-checkbox>
                                            </template>
                                            <!-- sistema por puntos -->
                                            ...
                                            <template v-if="fnApplyRestrictSaleItemsCpe && isGeneratedFromExternal">
                                                <template v-if="fnIsRestrictedForSale(row.item, form.document_type_id)">
                                                    <span class="text-danger mt-1 mb-2 d-block">Restringido para venta
                                                        en CPE</span>
                                                </template>
                                            </template>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <button type="button"
                                                ...
                                                @click.prevent="openDialogLots(row)" v-if="row.item.series_enabled">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center pt-3" colspan="2">
                                            <el-popover placement="top-start" :open-delay="1000" width="145"
                                                trigger="hover" content="Presiona F2">
                                        ...
                                        <td class="p-0" colspan="5">
                                            <div class="row table-responsive">
                                                <table class="table-sm text-right hidden-sm-down" style="width: 100%;">
                                                    ...
                                                    <template v-if="form.has_retention">
                                                        ...
                                                        <tr v-if="form.retention.amount > 0">
                                                            <td>M. RETENCIÓN ({{ form.retention.percentage * 100 }}%):
                                                            </td>
                                                            <td>{{ currency_type.symbol }} {{ form.retention.amount }}
                                                            </td>
                                                        </tr>
                                                        <tr v-if="form.total > 0">
                                                            <td><strong>TOTAL A PAGAR</strong>:</td>
                                                            <td>{{ currency_type.symbol }} {{ form.total -
                                                                form.retention.amount }}</td>
                                                        </tr>
                                                    </template>
                                                    <template v-if="!form.has_retention">
                                                        <tr v-if="form.total > 0">
                                                    ...
                                                    <tr v-if="form.total > 0">
                                                        ...
                                                        <td class="p-0" colspan="2">
                                                            ...
                                                            <div v-if="form.payment_condition_id === '03'"
                                                                ...
                                                                <table class="text-left table" width="100%">
                                                                    <thead>
                        ...
                        <div class="row hidden-md-up">
                            ...
                            <div class="col-12 text-center table-responsive">
                                <table class="table table-sm text-right" style="width: 100%;">
                                    <tr v-if="form.total > 0 && enabled_discount_global">
                                        <td>
                                                ...
                                                <table class="text-left" width="100%">
                                                    <thead>
                                                        <tr v-if="form.fee.length > 0">
                                                            ...
                                                            <th class="text-left" style="width: 100px">Monto
                                                            </th>
                                                            <th style="width: 30px"></th>
                                                        </tr>
                                                    </thead>
                                                        ...
                                                        <tr v-for="(row, index) in form.fee" :key="index">
                                                            <td>
                                                                <el-select v-model="row.payment_method_type_id"
                                                                    @change="changePaymentMethodType(index)">
                                                                    <el-option v-for="option in credit_payment_metod"
                                                                        :key="option.id" :label="option.description"
                                                                        :value="option.id"></el-option>
                                                                </el-select>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr v-for="(row, index) in form.payments" :key="index">
                                                            ...
                                                            <template v-if="showLoadVoucher">
                                                                <td class="" style="width: 50px">
                                                                    <!-- <el-tooltip class="item" content="Cargar voucher" effect="dark" placement="top-start"> -->
                                                                    <el-upload :data="{ 'index': index }"
                                                                        :headers="headers_token" :multiple="false"
                                                                        :on-remove="(file, fileList) => handleRemoveUploadVoucher(file, fileList, index)"
                                                                        :action="`/finances/payment-file/upload`"
                                                                        :show-file-list="true"
                                                                        :file-list="row.file_list"
                    ...
                    <div class="card-footer text-right  hidden-sm-down">
                        <button class="btn btn-default" style="min-width: 180px" @click.prevent="close()">Cancelar
                        </button>
                        <el-popover placement="top-start" :open-delay="1000" width="145" trigger="hover"
                            content="Presiona ALT + G">
                            <el-button slot="reference" v-if="form.items.length > 0 && this.dateValid"
                                :loading="loading_submit" class="submit btn btn-primary" native-type="submit"
                    ...
                    <div class="card-footer   hidden-md-up ">
                        <div class="col-12 row text-center">
                            <div class="col-6 text-center">
                                <button class="btn btn-default form-control" @click.prevent="close()">Cancelar
                                </button>
                            </div>
                            <div class="col-6 text-center">

                                <el-button v-if="form.items.length > 0 && this.dateValid" :loading="loading_submit"
                                    class="submit btn btn-primary form-control" native-type="submit">{{ btnText }}
                                </el-button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body d-flex align-items-start no-gutters">
                        <div class="col-12">
                                ...
                                <template v-if="!is_client">
                                    <div class="col-12 py-2 px-0">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-2">
                                                <el-switch v-if="!prepayment_deduction" v-model="form.has_prepayment"
                                    ...
                                    <div class="col-12 py-2 px-0">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-2">
                                                <el-switch v-if="!form.has_prepayment" v-model="prepayment_deduction"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <el-select v-if="form.has_prepayment || prepayment_deduction"
                                                v-model="form.affectation_type_prepayment" class="mb-2"
                                    ...
                                    <template v-if="!is_client">
                                        <div v-if="prepayment_deduction" class="">
                                            <div class="form-group">
                                                <table style="width: 100%">
                                                    <tr v-for="(row, index) in form.prepayments" :key="index">
                                                        <td>
                                                            <el-select v-model="row.document_id" filterable
                                                ...
                                                <label class="control-label">
                                                    <a class="" href="#" @click.prevent="clickAddPrepayment"><i
                                                            class="fa fa-plus font-weight-bold text-info"></i>
                                                        <span style="color: #777777">Agregar comprobante
                                                            anticipado</span></a>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div v-if="config.active_allowance_charge && form.total > 0"
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-4">
                                                <el-input-number v-model="config.percentage_allowance_charge" :min="0"
                                    ...
                                    <div class="row p-2 border-top">
                                        ...
                                        <div class="col-12 py-2 border-top">
                                            <div :class="{ 'has-danger': errors.purchase_order }" class="form-group">
                                                ...
                                                <el-input v-model="form.purchase_order" type="textarea">
                                                </el-input>
                                                <small v-if="errors.purchase_order" class="form-control-feedback"
                                        ...
                                        <div class="col-12 py-2 border-top">
                                            <div class="form-group">
                                                ...
                                                <el-input v-model="form.additional_information" autosize
                                                    type="textarea">
                                                </el-input>
                                            </div>
                                        </div>
                                        <div class="col-md-12 py-2 border-top">
                                            <div :class="{ 'has-danger': errors.plate_number }" class="form-group">
                                                ...
                                                <el-input v-model="form.plate_number" type="textarea">
                                                </el-input>
                                                <small v-if="errors.plate_number" class="form-control-feedback"
                                        ...
                                        <template v-if="config.enabled_tips_pos && !isUpdateDocument">
                                            <set-tip class="full py-2 border-top mb-1 mt-2"
                                                @changeDataTip="changeDataTip"></set-tip>
                                        </template>
                                        <!-- propinas -->
                            ...
                            <div v-if="isActiveBussinessTurn('hotel')" class="">
                                <el-tooltip class="item my-2" content="Datos personales para reserva de hospedaje"
                            ...
                            <div v-if="isActiveBussinessTurn('transport')" class="">
                                <el-tooltip class="item my-2" content="Datos para transporte de pasajeros" effect="dark"
                                    placement="bottom-end">
                                    <button class="btn btn-primary btn-block"
                                        @click.prevent="clickAddDocumentTransport">Datos de
                                        transporte
                                    </button>
                                </el-tooltip>
                            </div>
                            <button class="btn btn-primary btn-block mt-2" :disabled="form.customer_id == null"
        ...
        <document-report-customer :showDialog.sync="showDialogReportCustomer"
            :customerId="report_to_customer_id"></document-report-customer>

        <document-form-item :configuration="config" :currency-type-id-active="form.currency_type_id"
            :documentId="documentId" :editNameProduct="config.edit_name_product"
            :exchange-rate-sale="form.exchange_rate_sale" :isEditItemNote="false"
            :operation-type-id="form.operation_type_id" :recordItem="recordItem" :showDialog.sync="showDialogAddItem"
            :typeUser="typeUser" :customer-id="form.customer_id" :currency-types="currency_types"
            :is-from-invoice="true" :percentage-igv="percentage_igv" :isUpdateDocument="isUpdateDocument"
            @add="addRow"></document-form-item>

        <person-form :document_type_id=form.document_type_id :external="true" :input_person="input_person"
            :showDialog.sync="showDialogNewPerson" type="customers"></person-form>

        <document-options :configuration="config" :isContingency="is_contingency" :isUpdate="isUpdate"
            :recordId="documentNewId" :table="table" :showClose="false"
            :showDialog.sync="showDialogOptions"></document-options>


        <document-hotel-form :hotel="form.hotel" :showDialog.sync="showDialogFormHotel"
            @addDocumentHotel="addDocumentHotel"></document-hotel-form>

        <document-transport-form :showDialog.sync="showDialogFormTransport" :transport="form.transport"
            @addDocumentTransport="addDocumentTransport"></document-transport-form>

        <document-detraction :currency-type-id-active="form.currency_type_id" :detraction="form.detraction"
            :exchange-rate-sale="form.exchange_rate_sale" :operation-type-id="form.operation_type_id"
            :showDialog.sync="showDialogDocumentDetraction" :total="form.total" :isUpdateDocument="isUpdateDocument"
            :detractionDecimalQuantity="detractionDecimalQuantity"
            @addDocumentDetraction="addDocumentDetraction"></document-detraction>

        <store-item-series-index :show-dialog.sync="showDialogItemSeriesIndex" :item="recordItem"
            :document-id="documentId" @success="successItemSeries"></store-item-series-index>
    </div>
</template>
