  ...
  <el-dialog 
    ...
    <form autocomplete="off" @submit.prevent="submit">
      <el-tabs v-model="activeName">
        <el-tab-pane class name="first">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="">
                <div 
                  :class="{ 'has-danger': errors.has_plastic_bag_taxes }" 
                  class="form-group"
                  >
            ...
            <div class="col-md-12">
              <!-- <div :class="{ 'has-danger': errors.name }" class="form-group">
                ...
                <textarea v-model="form.name" class="form-control" rows="8"></textarea>
                <small
                  v-if="errors.name"
                  class="form-control-feedback"
            ...
            <div class="col-md-12">
              <div 
                :class="{ 'has-danger': errors.caracteristicas }" 
                class="form-group"
              >
                ...
                <small 
                  ...
                  class="form-control-feedback"
                  v-text="errors.caracteristicas[0]"></small>
              </div>
            </div>
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.unit_type_id }" class="form-group">
                ...
                <el-select v-model="form.unit_type_id" dusk="unit_type_id">
                  <el-option v-for="option in unit_types" :key="option.id" :label="option.description"
                    :value="option.id"></el-option>
                </el-select>
                <small v-if="errors.unit_type_id" class="form-control-feedback" v-text="errors.unit_type_id[0]"></small>
              </div>
            </div>
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.currency_type_id }" class="form-group">
                ...
                <el-select v-model="form.currency_type_id" dusk="currency_type_id">
                  <el-option v-for="option in currency_types" :key="option.id" :label="option.description"
                    :value="option.id"></el-option>
                </el-select>
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.sale_unit_price }" class="form-group">
                ...
                <el-input v-model="form.sale_unit_price" dusk="sale_unit_price"
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.sale_affectation_igv_type_id }" class="form-group">
                ...
                <el-select v-model="form.sale_affectation_igv_type_id" filterable @change="changeAffectationIgvType">
                  <el-option v-for="option in affectation_igv_types" :key="option.id" :label="option.description"
                    :value="option.id"></el-option>
                </el-select>
                <small v-if="errors.sale_affectation_igv_type_id" class="form-control-feedback"
                  v-text="errors.sale_affectation_igv_type_id[0]"></small>
              </div>
            </div>
            <div class="col-12"></div>
            <div v-if="form.unit_type_id != 'ZZ'" v-show="recordId == null" class="col-md-3">
              <div :class="{ 'has-danger': errors.warehouse_id }" class="form-group">
                ...
                <small v-if="errors.warehouse_id" class="form-control-feedback" v-text="errors.warehouse_id[0]"></small>
              </div>
            </div>
            <div v-show="recordId == null && form.unit_type_id != 'ZZ'" class="col-md-3">
              <div :class="{ 'has-danger': errors.stock }" class="form-group">
                <label class="control-label">Stock Inicial</label>
                <el-input v-model="form.stock"></el-input>
                <small v-if="errors.stock" class="form-control-feedback" v-text="errors.stock[0]"></small>
              </div>
            </div>
            <div v-show="form.unit_type_id != 'ZZ'" class="col-md-3">
              <div :class="{ 'has-danger': errors.stock_min }" class="form-group">
                ...
                <small v-if="errors.stock_min" class="form-control-feedback" v-text="errors.stock_min[0]"></small>
              </div>
            </div>
            <div v-show="form.unit_type_id != 'ZZ'" class="col-md-3">
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.barcode }" class="form-group">
                ...
                <small v-if="errors.barcode" class="form-control-feedback" v-text="errors.barcode[0]"></small>
              </div>
            </div>

            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.factory_code }" class="form-group">
                <label class="control-label">
                  Código de fábrica
                  <el-tooltip class="item"
                    content="Para habilitar la búsqueda debe realizarlo en configuración/avanzado" effect="dark"
                    placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.factory_code"> </el-input>
                <small v-if="errors.factory_code" class="form-control-feedback" v-text="errors.factory_code[0]"></small>
              </div>
            </div>

            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.item_code }" class="form-group">
                <label class="control-label">Código Sunat
                  <el-tooltip class="item"
                    content="Código proporcionado por SUNAT, campo obligatorio para exportaciones" effect="dark"
                    placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.item_code" dusk="item_code"></el-input>
                <small v-if="errors.item_code" class="form-control-feedback" v-text="errors.item_code[0]"></small>
              </div>
            </div>
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.line }" class="form-group">
                <label class="control-label">
                  Línea de producto
                  <el-tooltip class="item" content="Grupo de productos que tienen una relación directa entre sí"
                    effect="dark" placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.line"> </el-input>
                <small v-if="errors.line" class="form-control-feedback" v-text="errors.line[0]"></small>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.internal_id }" class="form-group">
                <label class="control-label">Código Interno
                  <el-tooltip class="item" content="Código interno de la empresa para el control de sus productos"
                    effect="dark" placement="top-start">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.internal_id" dusk="internal_id"></el-input>
                <small v-if="errors.internal_id" class="form-control-feedback" v-text="errors.internal_id[0]"></small>
              </div>
            </div>

            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.procedencia }" class="form-group">
                <label class="control-label">Procedencia</label>
                <el-input v-model="form.procedencia"></el-input>
                <small v-if="errors.procedencia" class="form-control-feedback" v-text="errors.procedencia[0]"></small>
              </div>
            </div>

            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.pais }" class="form-group">
                <label class="control-label">País</label>
                <el-input v-model="form.pais"></el-input>
                <small v-if="errors.pais" class="form-control-feedback" v-text="errors.pais[0]"></small>
              </div>
            </div>
              ...
              <div class="table-responsive">
                <table class="table table-sm mb-0 table-borderless">
                  <thead>
                    <tr>
                      <th width="25%">
                        <el-checkbox v-model="form.has_perception" @change="changeHasPerception">Incluye percepción
                        </el-checkbox>
                      </th>
                      <th width="25%">
                        <div v-show="form.unit_type_id != 'ZZ'">
                          <el-checkbox v-model="form.lots_enabled" @change="changeLotsEnabled">¿Maneja lotes?
                          </el-checkbox>
                        </div>
                      </th>
                      <th width="25%">
                      ...
                      <th width="25%">
                        <div v-show="form.unit_type_id != 'ZZ' && canSeeProduction">
                          <el-checkbox v-model="form.is_for_production" @change="changeProductioTab">Este producto,
                            ¿requiere insumos?
                          </el-checkbox>
                        </div>
                      </th>
                    ...
                    <tr>
                      ...
                      <td>
                        <div v-show="form.unit_type_id != 'ZZ' &&
                          ...
                          ">
                          <div :class="{ 'has-danger': errors.lot_code }" class="form-group">
                            <el-button icon="el-icon-edit-outline" size="small" type="primary"
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.has_isc }" class="form-group">
                <el-checkbox v-model="form.has_isc" @change="changeIsc">Incluye ISC
                </el-checkbox>
                <br />
                <small v-if="errors.has_isc" class="form-control-feedback" v-text="errors.has_isc[0]"></small>
              </div>
            </div>

            <template v-if="form.has_isc">
              <div class="col-md-3">
                <div :class="{ 'has-danger': errors.system_isc_type_id }" class="form-group">
                  <label class="control-label">Tipo de sistema ISC</label>
                  <el-select v-model="form.system_isc_type_id" filterable>
                    <el-option v-for="option in system_isc_types" :key="option.id" :label="option.description"
                      :value="option.id"></el-option>
                  </el-select>
                  <small v-if="errors.system_isc_type_id" class="form-control-feedback"
                    v-text="errors.system_isc_type_id[0]"></small>
                </div>
              </div>

              <div class="col-md-3">
                <div :class="{ 'has-danger': errors.percentage_isc }" class="form-group">
                  <label class="control-label">Porcentaje ISC</label>
                  <el-input v-model="form.percentage_isc"></el-input>
                  <small v-if="errors.percentage_isc" class="form-control-feedback"
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.subject_to_detraction }" class="form-group">
                <el-checkbox v-model="form.subject_to_detraction">Sujeto a detracción</el-checkbox>
                <br />
                <small v-if="errors.subject_to_detraction" class="form-control-feedback"
                  v-text="errors.subject_to_detraction[0]"></small>
              </div>
            </div>

            <div class="col-md-3" v-if="showRestrictSaleItemsCpe">
              <div :class="{ 'has-danger': errors.restrict_sale_cpe }" class="form-group">
                <el-checkbox v-model="form.restrict_sale_cpe">Restringir venta en CPE</el-checkbox>
                <br />
                <small v-if="errors.restrict_sale_cpe" class="form-control-feedback"
            ...
            <template v-if="showPointSystem">
              <div class="col-md-3">
                <div :class="{ 'has-danger': errors.exchange_points }" class="form-group">
                  <el-checkbox v-model="form.exchange_points">¿Se puede canjear por puntos?</el-checkbox>
                  <br />
                  <small v-if="errors.exchange_points" class="form-control-feedback"
              ...
              <div class="col-md-3 mb-2" v-if="form.exchange_points">
                <label class="control-label">
                  N° de puntos
                  <el-tooltip class="item" content="Total de puntos que necesitará el cliente para canjear el producto."
                    effect="dark" placement="top-start">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <div :class="{ 'has-danger': errors.quantity_of_points }" class="form-group">
                  <el-input-number v-model="form.quantity_of_points" :min="0.01" :precision="2" :step="1"
        ...
        <el-tab-pane class v-if="showPharmaElement" name="seven">
          <span slot="label">Droguería/Farma</span>
          <div class="row">
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.sanitary }" class="form-group">
                <label class="control-label">
                  Registro Sanitario
                  <el-tooltip class="item" content="Número de registro sanitario" effect="dark" placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.sanitary"> </el-input>
                <small v-if="errors.sanitary" class="form-control-feedback" v-text="errors.sanitary[0]"></small>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.cod_digemid }" class="form-group">
                <label class="control-label">
                  Código DIGEMID
                  <el-tooltip class="item" content="Código de observación DIGEMID" effect="dark" placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.cod_digemid"> </el-input>
                <small v-if="errors.cod_digemid" class="form-control-feedback" v-text="errors.cod_digemid[0]"></small>
              </div>
            </div>

            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.concentracion }" class="form-group">
                <label class="control-label">
                  Concentración
                  <el-tooltip class="item" content="Concentración de observación DIGEMID" effect="dark" placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </label>
                <el-input v-model="form.concentracion"> </el-input>
                <small v-if="errors.concentracion" class="form-control-feedback"
                  v-text="errors.concentracion[0]"></small>
              </div>
            </div>

            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.act_principles_id }" class="form-group">
                <label class="control-label"> Principio Activo </label>

                <a v-if="form_act_principles.add == false" class="control-label font-weight-bold text-info" href="#"
                  @click="form_act_principles.add = true">
                  [ + Nuevo]</a>
                <a v-if="form_act_principles.add == true" class="control-label font-weight-bold text-info" href="#"
                  @click="saveActPrinciples()">
                  [ + Guardar]</a>
                <a v-if="form_act_principles.add == true" class="control-label font-weight-bold text-danger" href="#"
                  @click="form_act_principles.add = false">
                  [ Cancelar]</a>
                <el-input v-if="form_act_principles.add == true" v-model="form_act_principles.name" dusk="item_code"
                  style="margin-bottom: 1.5%"></el-input>

                <el-select v-if="form_act_principles.add == false" v-model="form.act_principles_id" clearable
                  filterable>
                  <el-option v-for="option in active_principles" :key="option.id" :label="option.name"
                    :value="option.id"></el-option>
                </el-select>
                <small v-if="errors.act_principles_id" class="form-control-feedback"
                  v-text="errors.act_principles_id[0]"></small>
              </div>

            </div>

            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.laboratory_id }" class="form-group">
                <label class="control-label"> Laboratorio </label>

                <a v-if="form_laboratory.add == false" class="control-label font-weight-bold text-info" href="#"
                  @click="form_laboratory.add = true">
                  [ + Nuevo]</a>
                <a v-if="form_laboratory.add == true" class="control-label font-weight-bold text-info" href="#"
                  @click="saveLaboratory()">
                  [ + Guardar]</a>
                <a v-if="form_laboratory.add == true" class="control-label font-weight-bold text-danger" href="#"
                  @click="form_laboratory.add = false">
                  [ Cancelar]</a>
                <el-input v-if="form_laboratory.add == true" v-model="form_laboratory.name" dusk="item_code"
                  style="margin-bottom: 1.5%"></el-input>

                <el-select v-if="form_laboratory.add == false" v-model="form.laboratory_id" clearable filterable>
                  <el-option v-for="option in laboratory" :key="option.id" :label="option.name"
                    :value="option.id"></el-option>
                </el-select>
                <small v-if="errors.laboratory_id" class="form-control-feedback"
                  v-text="errors.laboratory_id[0]"></small>
              </div>
            </div>

            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.pharma_action_id }" class="form-group">
                <label class="control-label"> Acción Farmacológica </label>

                <a v-if="form_pharma_action.add == false" class="control-label font-weight-bold text-info" href="#"
                  @click="form_pharma_action.add = true">
                  [ + Nuevo]</a>
                <a v-if="form_pharma_action.add == true" class="control-label font-weight-bold text-info" href="#"
                  @click="savePharmaAction()">
                  [ + Guardar]</a>
                <a v-if="form_pharma_action.add == true" class="control-label font-weight-bold text-danger" href="#"
                  @click="form_pharma_action.add = false">
                  [ Cancelar]</a>
                <el-input v-if="form_pharma_action.add == true" v-model="form_pharma_action.name" dusk="item_code"
                  style="margin-bottom: 1.5%"></el-input>

                <el-select v-if="form_pharma_action.add == false" v-model="form.pharma_action_id" clearable filterable>
                  <el-option v-for="option in pharmacological_action" :key="option.id" :label="option.name"
                    :value="option.id"></el-option>
                </el-select>
                <small v-if="errors.pharma_action_id" class="form-control-feedback"
                  v-text="errors.pharma_action_id[0]"></small>
              </div>
            </div>
          </div>
          <div class="col-md-12 mt-3">
            <div class="form-group">
              <el-checkbox v-model="form.consider_temperature">
                ¿Considerar Temperatura?
              </el-checkbox>
            </div>
          </div>
          <!-- Campos de temperatura -->
          <div v-show="form.consider_temperature" class="row">
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.temp_inicial }" class="form-group">
                <label class="control-label">Temp. Inicial</label>
                <el-input v-model="form.temp_inicial" type="number" min="0" step="0.1" placeholder=""></el-input>
                <small v-if="errors.temp_inicial" class="form-control-feedback" v-text="errors.temp_inicial[0]"></small>
              </div>
            </div>
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.temp_final }" class="form-group">
                <label class="control-label">Temp. Final</label>
                <el-input v-model="form.temp_final" type="number" min="0" step="0.1" placeholder=""></el-input>
                <small v-if="errors.temp_final" class="form-control-feedback" v-text="errors.temp_final[0]"></small>
              </div>
            </div>
          </div>

          <!-- Nueva sección para cargar archivos PDF -->
    <div class="col-md-12 mt-4">
      <h5 class="separator-title">Archivos Opcionales</h5>
      <div class="form-group">
        <label class="control-label">Subir Archivos (PDF)</label>
        <div class="row">
          <div class="col-md-6 mb-2">
            <el-upload
              ...
              :file-list="fileList.brochure">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">Brochure de Producto</div>
            </el-upload>
          </div>
          <div class="col-md-6 mb-2">
            <el-upload
              ...
              accept=".pdf"
              :on-success="handleUploadSuccess"
              :file-list="fileList.technicalAnalysis">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">Análisis Técnico</div>
            </el-upload>
          </div>
          <div class="col-md-6 mb-2">
            <el-upload
              ...
              accept=".pdf"
              :on-success="handleUploadSuccess"
              :file-list="fileList.bpa">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">Buenas Prácticas de Almacenamiento (BPA)</div>
            </el-upload>
          </div>
          <div class="col-md-6 mb-2">
            <el-upload
              ...
              accept=".pdf"
              :on-success="handleUploadSuccess"
              :file-list="fileList.sanitaryRegistration">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">Registro Sanitario</div>
            </el-upload>
          </div>
        </div>
      </div>
        ...
        <el-tab-pane class v-if="!isService" name="third">
          ...
          <div class="row">
            ...
            <div v-if="form.item_unit_types.length > 0" v-show="form.unit_type_id != 'ZZ'" class="col-md-12">
              <div class="table-responsive">
                  ...
                  <thead class="bg-light">
                    <tr>
                      ...
                      <th class="text-center">
                        Factor
                        <el-tooltip class="item" content="Cantidad de unidades" effect="dark" placement="top">
                          <i class="fa fa-info-circle"></i>
                        </el-tooltip>
                      </th>
                        ...
                        <td>
                          <div>
                            <el-select v-model="row.price_default">
                              <el-option :key="1" :value="1" label="Precio 1"></el-option>
                              <el-option :key="2" :value="2" label="Precio 2"></el-option>
                              <el-option :key="3" :value="3" label="Precio 3"></el-option>
                            </el-select>
                          </div>
                        </td>
                        <td class="series-table-actions text-right">
            ...
            <div class="col">
              <a class="control-label font-weight-bold text-info" href="#" @click="clickAddRow">
                [ + Agregar]</a>
            </div>
          </div>
        </el-tab-pane>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                ...
                <el-upload :action="`/${resource}/upload`" :data="{ type: 'items' }" :headers="headers"
                  :on-success="onSuccess" :show-file-list="false" class="avatar-uploader">
            ...
            <div class="col-md-9">
              <div class="row">
                ...
                <div class="col-md-4">
                  <div :class="{ 'has-danger': errors.category_id }" class="form-group">
                    ...
                    <a v-if="form_category.add == false" class="control-label font-weight-bold text-info" href="#"
                      @click="form_category.add = true">
                      [ + Nuevo]</a>
                    <a v-if="form_category.add == true" class="control-label font-weight-bold text-info" href="#"
                      @click="saveCategory()">
                      [ + Guardar]</a>
                    <a v-if="form_category.add == true" class="control-label font-weight-bold text-danger" href="#"
                      @click="form_category.add = false">
                      [ Cancelar]</a>
                    <el-input v-if="form_category.add == true" v-model="form_category.name" dusk="item_code"
                      style="margin-bottom: 1.5%"></el-input>

                    <el-select v-if="form_category.add == false" v-model="form.category_id" clearable filterable>
                ...
                <div class="col-md-4">
                  <div :class="{ 'has-danger': errors.brand_id }" class="form-group">
                    ...
                    <a v-if="form_brand.add == false" class="control-label font-weight-bold text-info" href="#"
                      @click="form_brand.add = true">
                      [ + Nuevo]</a>
                    <a v-if="form_brand.add == true" class="control-label font-weight-bold text-info" href="#"
                      @click="saveBrand()">
                      [ + Guardar]</a>
                    <a v-if="form_brand.add == true" class="control-label font-weight-bold text-danger" href="#"
                      @click="form_brand.add = false">
                      [ Cancelar]</a>
                    <el-input v-if="form_brand.add == true" v-model="form_brand.name" dusk="item_code"
                      style="margin-bottom: 1.5%"></el-input>

                    <el-select v-if="form_brand.add == false" v-model="form.brand_id" clearable filterable>
                      <el-option v-for="option in brands" :key="option.id" :label="option.name"
                        :value="option.id"></el-option>
                    </el-select>
                    <small v-if="errors.brand_id" class="form-control-feedback" v-text="errors.brand_id[0]"></small>
                  </div>
                </div>
                <div class="col-md-4">
                  <div :class="{ 'has-danger': errors.subgroup_id }" class="form-group">
                    <label class="control-label"> Grupo </label>

                    <a v-if="form_subgroup.add == false" class="control-label font-weight-bold text-info" href="#"
                      @click="prepareNewSubgroup">
                      [ + Nuevo]</a>
                    <a v-if="form_subgroup.add == true" class="control-label font-weight-bold text-info" href="#"
                      @click="saveSubgroup">
                      [ + Guardar]</a>
                    <a v-if="form_subgroup.add == true" class="control-label font-weight-bold text-danger" href="#"
                      @click="cancelNewSubgroup">
                      [ Cancelar]</a>
                    <el-input v-if="form_subgroup.add == true" v-model="form_subgroup.name" dusk="item_code"
                      style="margin-bottom: 1.5%"></el-input>

                    <el-select v-if="form_subgroup.add == false" v-model="form.subgroup_id" clearable filterable>
                      <el-option v-for="option in filteredSubgroups" :key="option.id" :label="option.name"
                        :value="option.id"></el-option>
                    </el-select>
                    <small v-if="errors.subgroup_id" class="form-control-feedback"
                      v-text="errors.subgroup_id[0]"></small>
                  </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                  <div :class="{ 'has-danger': errors.color }" class="form-group">
                    <label class="control-label">Color</label>
                    <el-input v-model="form.color" dusk="color"></el-input>
                    <small v-if="errors.color" class="form-control-feedback" v-text="errors.color[0]"></small>
                  </div>
                </div>
                <div class="col-md-3">
                  <div :class="{ 'has-danger': errors.size }" class="form-group">
                    <label class="control-label">Tamaño</label>
                    <el-input v-model="form.size" dusk="size"></el-input>
                    <small v-if="errors.size" class="form-control-feedback" v-text="errors.size[0]"></small>
                  </div>
                </div>
                <div class="col-md-3">
                  <div :class="{ 'has-danger': errors.sexo }" class="form-group">
                    <label class="control-label">Sexo</label>
                    <el-select v-model="form.sexo" dusk="sexo" clearable>
                      <el-option key="H" label="Hombre" value="H"></el-option>
                      <el-option key="M" label="Mujer" value="M"></el-option>
                      <el-option key="O" label="Niño" value="O"></el-option>
                      <el-option key="A" label="Niña" value="A"></el-option>
                    </el-select>
                    <small v-if="errors.sexo" class="form-control-feedback" v-text="errors.sexo[0]"></small>
                  </div>
                </div>
              </div>
              <div v-if="attribute_types.length > 0">
                <h5 class="separator-title mb-0">
                  Listado
                  <el-tooltip class="item" content="Diferentes presentaciones para la venta del producto" effect="dark"
                    placement="top">
                    <i class="fa fa-info-circle"></i>
                  </el-tooltip>
                </h5>
                      ...
                      <tr v-for="(row, index) in form.attributes" :key="index">
                        <td>
                          <el-select v-model="row.attribute_type_id" filterable @change="changeAttributeType(index)">
                            <el-option v-for="option in attribute_types" :key="option.id" :label="option.description"
                              :value="option.id"></el-option>
                          </el-select>
                        </td>
                        <td>
                        ...
                        <td>
                          <button class="btn btn-danger btn-sm" type="button"
                            @click.prevent="clickRemoveAttribute(index)">
                            x
                          </button>
                        </td>
                      </tr>
              ...
              <a class="control-label font-weight-bold text-info" href="#" @click.prevent="clickAddAttribute">[+
                Agregar]</a>
            </div>
          </div>
        </el-tab-pane>
          ...
          <div class="row">
            <div class="col-md-8">
              <div :class="{
                ...
                <small v-if="errors.purchase_affectation_igv_type_id" class="form-control-feedback"
            ...
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.purchase_unit_price }" class="form-group">
                ...
                <el-input v-model="form.purchase_unit_price" dusk="purchase_unit_price"
                  @input="calculatePercentageOfProfitByPurchase"></el-input>
                <small v-if="errors.purchase_unit_price" class="form-control-feedback"
                  v-text="errors.purchase_unit_price[0]"></small>
              </div>
            </div>
            <div v-show="purchase_show_has_igv" class="col-md-4 center-el-checkbox pt-2">
              <div :class="{ 'has-danger': errors.purchase_has_igv }" class="form-group">
                <el-checkbox v-model="form.purchase_has_igv">Incluye Igv</el-checkbox>
                <br />
                <small v-if="errors.purchase_has_igv" class="form-control-feedback"
                  v-text="errors.purchase_has_igv[0]"></small>
              </div>
            </div>
            <div class="col-md-4 center-el-checkbox pt-2">
              <div class="form-group">
                <el-checkbox v-model="enabled_percentage_of_profit" @change="changeEnabledPercentageOfProfit">Aplica
                  ganancia
                </el-checkbox>
                <br />
              </div>
            ...
            <div class="col-md-4 pt-2">
              <div :class="{ 'has-danger': errors.percentage_of_profit }" class="form-group">
                ...
                <small v-if="errors.percentage_of_profit" class="form-control-feedback"
            ...
            <!-- isc compras -->
            <div class="col-md-4">
              <div :class="{ 'has-danger': errors.purchase_has_isc }" class="form-group">
                <el-checkbox v-model="form.purchase_has_isc" @change="purchaseChangeIsc">Incluye ISC
                </el-checkbox>
                <br />
                <small v-if="errors.purchase_has_isc" class="form-control-feedback"
            ...
            <template v-if="form.purchase_has_isc">
              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.purchase_system_isc_type_id }" class="form-group">
                  <label class="control-label">Tipo de sistema ISC</label>
                  <el-select v-model="form.purchase_system_isc_type_id" filterable>
                    <el-option v-for="option in system_isc_types" :key="option.id" :label="option.description"
                      :value="option.id"></el-option>
                  </el-select>
                  <small v-if="errors.purchase_system_isc_type_id" class="form-control-feedback"
                    v-text="errors.purchase_system_isc_type_id[0]"></small>
                </div>
              </div>

              <div class="col-md-4">
                <div :class="{ 'has-danger': errors.purchase_percentage_isc }" class="form-group">
                  <label class="control-label">Porcentaje ISC</label>
                  <el-input v-model="form.purchase_percentage_isc"></el-input>
                  <small v-if="errors.purchase_percentage_isc" class="form-control-feedback"
        ...
        <el-tab-pane class v-if="form.is_for_production && canSeeProduction" name="six">
          ...
          <div class="row">
              ...
              <div id="custom-select" :class="{ 'has-danger': errors.item_id }" class="form-group">
                ...
                <template id="select-append">
                  <el-input id="custom-input">
                    <el-select id="select-width" ref="selectSearchNormal" slot="prepend" v-model="item_suplly"
                      :loading="loading_search" :remote-method="searchRemoteItems" filterable placeholder="Buscar"
                      popper-class="el-select-items" remote @change="changeItem" @focus="focusSelectItem">
            ...
            <div class="col-md-7 col-lg-7 col-xl-7 col-sm-7" style="margin-top: 1rem !important">
              <div class="form-group">
                <button class="btn waves-effect waves-light btn-primary" type="button" @click.prevent="clickAddSupply">
                  + Agregar Producto
                </button>
              </div>
            </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr v-for="(row, index) in form.supplies" :key="index">
                      ...
                      <td>
                        <el-input-number v-model="row.quantity"></el-input-number>
                      </td>
                    </tr>
                  </tbody>
                </table>
    ...
    <lots-form :lots="form.lots" :recordId="recordId" :showDialog.sync="showDialogLots" :stock="form.stock"
      @addRowLot="addRowLot">
    </lots-form>
  </el-dialog>
</template>
...
export default {
  ...
  computed: {
    ...
    filteredSubgroups() {
      return this.subgroups.filter(
        (subgroup) => subgroup.category_id === this.form.category_id
      );
    },
    isService: function () {
  ...
  data() {
    return {
      fileList: {
      brochure: [], // Lista de archivos para Brochure de Producto
      technicalAnalysis: [], // Lista de archivos para Análisis Técnico
      bpa: [], // Lista de archivos para Buenas Prácticas de Almacenamiento
      sanitaryRegistration: [] // Lista de archivos para Registro Sanitario
    },
      loading_search: false,
      showDialogLots: false,
      form_category: { add: false, name: null, id: null },
      form_brand: { add: false, name: null, id: null },
      form_act_principles: { add: false, name: null, id: null },
      form_laboratory: { add: false, name: null, id: null },
      form_pharma_action: { add: false, name: null, id: null },
      form_subgroup: { add: false, name: null, id: null },
      warehouses: [],
      items: [],
  ...
  async created() {
    ...
    await this.$http.get(`/${this.resource}/tables`).then((response) => {
      ...
      this.pharmacological_action = data.pharmacological_action;
  ...
  watch: {
    'form.consider_temperature'(newVal) {
      if (!newVal) {
        this.form.temp_inicial = null;
        this.form.temp_final = null;
      }
    },
  },
  ...
  methods: {
    ...
    prepareNewSubgroup() {
      this.form_subgroup.add = true;
      this.form_subgroup.name = "";
      this.form_subgroup.category_id = this.form.category_id; // Asocia la categoría seleccionada
    },
    handleUploadSuccess(response, file, fileList) {
    console.log('Archivo subido con éxito:', response, file, fileList);
    // Puedes agregar lógica adicional para procesar la respuesta del servidor
  },
    async saveSubgroup() {
      try {
        const response = await this.$http.post("/subgroups", {
          name: this.form_subgroup.name,
          category_id: this.form_subgroup.category_id,
        });
        if (response.data.success) {
          this.$message.success(response.data.message);
          this.subgroups.push(response.data.data); 
          this.form_subgroup.add = false;
          this.form_subgroup.name = null;
        } else {
          this.$message.error("Error al guardar el subgrupo");
        }
      } catch (error) {
    ...
    async reloadTables() {
      await this.$http.get(`/${this.resource}/tables`).then((response) => {
        ...
        this.active_principles = response.data.active_principles;
        this.laboratory = response.data.laboratory;
        this.pharmacological_action = response.data.pharmacological_action;
    ...
    initForm() {
      ...
      this.form = {
        ...
        category_id: null,
        brand_id: null,
        act_principles_id: null,
        laboratory_id: null,
        pharma_action_id: null,
        subgroup_id: null,
        consider_temperature: false,
        temp_inicial: null,
        temp_final: null,
      ...
      if (this.recordId) {
        await this.$http
          ...
          .then((response) => {
            ...
            this.form.temp_inicial = this.form.temp_inicial || null;
            this.form.temp_final = this.form.temp_final || null;
          });
      } else {
        this.form.name = "";
      }
    ...
    setDataToItemWarehousePrices() {
      this.warehouses.forEach((warehouse) => {
        let item_warehouse_price = _.find(this.form.item_warehouse_prices, {
    ...
    async submit() {
      ...
      if (this.form.consider_temperature) {
        if (this.form.temp_inicial !== null && isNaN(this.form.temp_inicial)) {
          return this.$message.error("La Temperatura Inicial debe ser un número.");
        }
        if (this.form.temp_final !== null && isNaN(this.form.temp_final)) {
          return this.$message.error("La Temperatura Final debe ser un número.");
        }
      }
    ...
    saveActPrinciples() {
      this.form_act_principles.add = false;

      this.$http
        .post(`/active_principles`, this.form_act_principles)
        .then((response) => {
          if (response.data.success) {
            this.$message.success(response.data.message);
            this.active_principles.push(response.data.data);
            this.form_act_principles.name = null;
          } else {
            this.$message.error("No se guardaron los cambios");
          }
        })
    ...
    saveLaboratory() {
      this.form_laboratory.add = false;

      this.$http
        .post(`/laboratory`, this.form_laboratory)
        .then((response) => {
          if (response.data.success) {
            this.$message.success(response.data.message);
            this.laboratory.push(response.data.data);
            this.form_laboratory.name = null;
          } else {
            this.$message.error("No se guardaron los cambios");
          }
        })
    ...
    savePharmaAction() {
      this.form_pharma_action.add = false;

      this.$http
        .post(`/pharmacological_action`, this.form_pharma_action)
        .then((response) => {
          if (response.data.success) {
            this.$message.success(response.data.message);
            this.pharmacological_action.push(response.data.data);
            this.form_pharma_action.name = null;
          } else {
            this.$message.error("No se guardaron los cambios");
          }
        })
    ...
    saveSubgroup() {
      ...
      this.$http
        .post(`/subgroups`, this.form_subgroup)
        .then((response) => {
          if (response.data.success) {
            this.$message.success(response.data.message);
            this.subgroups.push(response.data.data);
