      ...
      <el-tabs v-model="activeName">
        <el-tab-pane class name="first">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              >
                ...
                <small
                  ...
                  class="form-control-feedback"
                  v-text="errors.caracteristicas[0]"
                ></small>
              </div>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
              <div
                :class="{ 'has-danger': errors.procedencia }"
                class="form-group"
              >
                ...
                <table class="table table-sm mb-0 table-borderless">
                  <thead>
                    <tr>
                      <th width="25%">
                        <el-checkbox
                          v-model="form.has_perception"
                          @change="changeHasPerception"
                          >Incluye percepción
                        </el-checkbox>
                      </th>
                      <th width="25%">
                      ...
                      <th width="25%">
                        <div
                          v-show="form.unit_type_id != 'ZZ' && canSeeProduction"
                        >
                          <el-checkbox
                            v-model="form.is_for_production"
                            @change="changeProductioTab"
                            >Este producto, ¿requiere insumos?
                          </el-checkbox>
                        </div>
                      </th>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div
                          v-show="
                            form.unit_type_id != 'ZZ' && form.lots_enabled
                          "
                        >
                          <div
            ...
            <div class="col-md-3">
              <div :class="{ 'has-danger': errors.has_isc }" class="form-group">
                <el-checkbox v-model="form.has_isc" @change="changeIsc"
                  >Incluye ISC
                </el-checkbox>
                <br />
                <small
            ...
            <template v-if="form.has_isc">
              <div class="col-md-3">
                <div
                  :class="{ 'has-danger': errors.system_isc_type_id }"
                  class="form-group"
                >
              ...
              <div class="col-md-3">
                <div
                  :class="{ 'has-danger': errors.percentage_isc }"
                  class="form-group"
                >
            ...
            <div class="col-md-3">
              <div
                :class="{ 'has-danger': errors.subject_to_detraction }"
                class="form-group"
              >
                <el-checkbox v-model="form.subject_to_detraction"
            ...
            <div class="col-md-3" v-if="showRestrictSaleItemsCpe">
              <div
                :class="{ 'has-danger': errors.restrict_sale_cpe }"
                class="form-group"
              >
            ...
            <template v-if="showPointSystem">
              <div class="col-md-3">
                <div
                  :class="{ 'has-danger': errors.exchange_points }"
                  class="form-group"
                >
                  <el-checkbox v-model="form.exchange_points"
                    >¿Se puede canjear por puntos?</el-checkbox
                  >
                  <br />
                  <small
              ...
              <div class="col-md-3 mb-2" v-if="form.exchange_points">
                ...
                <div
                  :class="{ 'has-danger': errors.quantity_of_points }"
                  class="form-group"
                >
                  <el-input-number
        ...
        <el-tab-pane class v-if="showPharmaElement" name="seven">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div
                :class="{ 'has-danger': errors.concentracion }"
                class="form-group"
              >
                <label class="control-label">
                  Concentración
                  <el-tooltip
                    class="item"
                    content="Concentración de observación DIGEMID"
                    effect="dark"
                    placement="top"
                  >
                    <i class="fa fa-info-circle"></i>
          ...
          <div v-show="form.consider_temperature" class="col-md-6 mt-3">
            <div class="row">
            <div class="col-md-6">
              <div :class="{ 'has-danger': errors.temper_inicial }" class="form-group">
                <label class="control-label">Temperatura Inicial</label>
                <el-input v-model="form.temper_inicial" type="number" min="0" step="0.1" precision="2" placeholder=""></el-input>
                <small v-if="errors.temper_inicial" class="form-control-feedback" v-text="errors.temper_inicial[0]"></small>
              </div>
            </div>
            <div class="col-md-6">
              <div :class="{ 'has-danger': errors.temper_final }" class="form-group">
                <label class="control-label">Temperatura Final</label>
                <el-input v-model="form.temper_final" type="number" min="0" step="0.1" precision="2" placeholder=""></el-input>
                <small v-if="errors.temper_final" class="form-control-feedback" v-text="errors.temper_final[0]"></small>
              </div>
            </div>
            </div>
          </div>
          ...
          <div class="col-md-12 mt-3">
              <div class="form-group">
                <el-checkbox v-model="form.controlled_product">
          ...
          <div class="col-md-6">
            <div :class="{ 'has-danger': errors.brochure_pdf }" class="form-group">
              ...
              <el-upload
                ...
                :headers="headers"
              >
                <el-button size="small" type="primary">Subir PDF</el-button>
            </el-upload>
            <small
              v-if="errors.brochure_pdf"
              class="form-control-feedback"
              v-text="errors.brochure_pdf[0]"
            ></small>
            </div>
          </div>

          <div class="col-md-6">
            <div :class="{ 'has-danger': errors.analisis_pdf }" class="form-group">
              <label class="control-label">Análisis Técnico</label>
              <el-upload
                class="upload-demo"
                action="/uploads/analisis"
                :on-success="handleUploadSuccess"
                :data="{ type: 'analisis' }"
                :show-file-list="false"
                :headers="headers"
            ...
            <small
              v-if="errors.analisis_pdf"
              class="form-control-feedback"
              v-text="errors.analisis_pdf[0]"
            ></small>
            </div>
          </div>

          <div class="col-md-6">
            <div :class="{ 'has-danger': errors.bpa_pdf }" class="form-group">
              <label class="control-label">BPA</label>
              <el-upload
                class="upload-demo"
                action="/upload/bpa"
                :on-success="handleUploadSuccess"
          ...
          <div class="col-md-6">
            <div
              :class="{ 'has-danger': errors.registro_sanitario_pdf }"
              class="form-group"
            >
              <label class="control-label">Registro Sanitario</label>
              <el-upload
                class="upload-demo"
                action="/upload/registro_sanitario"
                :on-success="handleUploadSuccess"
                :data="{ type: 'registro_sanitario' }"
                :show-file-list="false"
                :headers="headers"
              >
            ...
            <small
              v-if="errors.registro_sanitario_pdf"
              class="form-control-feedback"
              v-text="errors.registro_sanitario_pdf[0]"
            ></small>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div
                    :class="{ 'has-danger': errors.brand_id }"
                    class="form-group"
                  >
        ...
        <el-tab-pane class v-if="!isService" name="five">
          ...
          <div class="row">
            ...
            >
              <div
                :class="{ 'has-danger': errors.purchase_has_igv }"
                class="form-group"
              >
            ...
            <div class="col-md-4">
              <div
                :class="{ 'has-danger': errors.purchase_has_isc }"
                class="form-group"
              >
                <el-checkbox
            ...
            <template v-if="form.purchase_has_isc">
              <div class="col-md-4">
                <div
                  :class="{ 'has-danger': errors.purchase_system_isc_type_id }"
                  class="form-group"
                >
                  <label class="control-label">Tipo de sistema ISC</label>
                  <el-select
                  ...
                  <small
                    ...
                    class="form-control-feedback"
                    v-text="errors.purchase_system_isc_type_id[0]"
                  ></small>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div
                  :class="{ 'has-danger': errors.purchase_percentage_isc }"
                  class="form-group"
                >
                  <label class="control-label">Porcentaje ISC</label>
                  ...
                  <small
                    ...
                    class="form-control-feedback"
                    v-text="errors.purchase_percentage_isc[0]"
                  ></small>
                </div>
              </div>
            </template>
...
export default {
  ...
  watch: {
    'form.consider_temperature'(newVal) {
      if (!newVal) {
        this.form.temper_inicial = null;
        this.form.temper_final = null;
      }
    },
  },
  ...
  methods: {
    ...
    handleUploadSuccess(response, file, fileList) {
      ...
      if (response.success) {
        if (response.data && response.data.type && response.data.filename) {
          const type = response.data.type;

          if (type === "brochure") this.form.brochure_pdf = response.data.filename;
      if (type === "analisis") this.form.analisis_pdf = response.data.filename;
      if (type === "bpa") this.form.bpa_pdf = response.data.filename;
      if (type === "registro_sanitario") this.form.registro_sanitario_pdf = response.data.filename;

      this.$message.success("Archivo subido con éxito");
    } else {
      console.error("La respuesta no contiene los datos esperados:", response);
      this.$message.error("Error en la estructura de la respuesta del servidor");
    }
  } else {
...
onUpload(file) {
  ...
  formData.append("type", "analisis"); // Especifica el tipo de archivo
  formData.append("id", this.form.id); // Asegúrate de que this.form.id contiene el ID del item

  axios
    .post("/api/items/upload-analisis", formData, {
      headers: {
      ...
      if (this.recordId) {
        await this.$http
          ...
          .then((response) => {
            ...
            this.form.temper_inicial = this.form.temper_inicial || null;
            this.form.temper_final = this.form.temper_final || null;
          });
      } else {
        this.form.name = "";
      }
    ...
    async submit() {
      ...
      await this.$http
        ...
        if (this.form.temper_inicial !== null && isNaN(this.form.temper_inicial)) {
          return this.$message.error("La Temperatura Inicial debe ser un número.");
        }
        if (this.form.temper_final !== null && isNaN(this.form.temper_final)) {
