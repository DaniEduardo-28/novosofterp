                    ...
                    <tr slot-scope="{ index, row }">
                        ...
                        <td class="text-center">
                            ...
                            <div class="btn-group flex-wrap">
                                ...
                                <div class="dropdown-menu" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 42px, 0px);">
                                    <a class="dropdown-item text-1" href="#" @click.prevent="clickDownloadProducts80(row.id, 'pdf')">Punto de venta - PDF - 80mm</a>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            clickDownloadProducts80(id, type)
            {
                window.open(`/${this.resource}/report/products80/${id}/false`, '_blank');
            },
