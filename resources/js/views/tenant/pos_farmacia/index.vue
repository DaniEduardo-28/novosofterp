<template>
  <div class="container-fluid p-0">
    <div class="row col-lg-12 page-header pr-0" style="height: auto">
      ...
      <div class="col-sm-5">
        ...
        <h2>
          <el-switch
            ...
            active-text="Buscar con escáner"
            @change="changeSearchItemBarcode"
          >
          </el-switch>
          <!-- <el-checkbox class="mt-1 font-weight-bold" v-model="omitir_enter"
            >No Enter</el-checkbox
          > -->
        ...
        <div class="row" v-if="search_item_by_barcode">
          ...
          <div class="col-md-12">
            <el-checkbox
              ...
              >Balanza electrónica</el-checkbox
            >

            <el-tooltip class="item" effect="dark" placement="top-start">
              <div slot="content">
                <b
                  >El código de barras generado por la balanza debe tener 16
                  caracteres:</b
                ><br /><br />
                - Los 5 primeros caracteres representan el código de barras del
                producto.<br />
                - Los 5 siguientes caracteres representan el peso, los 2
                primeros son el valor entero y los 3 siguientes son
                decimales.<br />
                - Los 6 siguientes caracteres representan el total, los 4
                primeros son el valor entero y los 2 siguientes son
                decimales.<br />
                <br />
        ...
        <!-- <el-tooltip
          ...
          >
            <button
              type="button"
              @click="back()"
              class="btn btn-custom btn-sm mt-2 mr-1 mr-sm-0"
            >
      ...
      <div class="col-sm-4">
        <div class="right-wrapper">
          ...
          <h2 class="text-sm pull-right" style="font-size: 14px">
            <el-select v-if="typeUser == 'admin'" v-model="form.seller_id" filterable clearable>
              <el-option
          ...
          <template v-for="(item, index) in items">
            <div v-bind:style="classObjectCol" :key="index">
              <section class="card">
                ...
                >
                  <p
                    v-if="configuration.show_complete_name_pos"
                    ...
                    <el-col :span="6">
                      ...
                      >
                        <button
                          ...
                          type="button"
                          class="btn btn-xs btn-primary-pos"
                          @click="clickWarehouseDetail(item)"
                        >
                          <i class="fa fa-search"></i>
                        </button>
                      </el-tooltip>
                    ...
                    <!-- <el-col :span="6" v-if="canSeeHistoryPurchase">
                      ...
                      >
                        <button
                          ...
                          style="width: 100%"
                          class="btn btn-xs btn-primary-pos"
                          @click="clickHistorySales(item.item_id)"
                        >
                    ...
                    <el-col :span="6" v-if="canSeePriceCost">
                      ...
                      >
                        <button
                          ...
                          style="width: 100%"
                          class="btn btn-xs btn-primary-pos"
                          @click="clickHistoryPurchases(item.item_id)"
                        >
                          ...
                          >
                            <el-table-column width="90" label="Precio">
                              <template slot-scope="{ row }">
                                <span v-if="row.price_default == 1">
                                  {{ row.price1 }}
                                </span>
                                <span v-else-if="row.price_default == 2">
                                  {{ row.price2 }}
                                </span>
                                <span v-else-if="row.price_default == 3">
                                  {{ row.price3 }}
                                </span>
                              </template>
                            </el-table-column>
          ...
          >
            ...
            >
              <table>
                ...
                <tr v-if="form.total_isc > 0" class="font-weight-semibold m-0">
...
export default {
  ...
  methods: {
    ...
    async events() {
      ...
      await this.$eventHub.$on("updateRecords", () => {
         this.getRecords();
      });
    ...
    getUnitPriceFromElectronicScale() {
      return _.round(
        this.electronic_scale_data.total / this.electronic_scale_data.weight,
        6
      );
    },
    ...
    async clickAddItem(item, index, input = false) {
      ...
      if (exist_item) {
        ...
        this.form_item.item = { ...item };
        this.form_item.item.is_farmacia = true;
        ...
        this.form_item.presentation = presentation ? presentation : null;
    ...
    calculateTotal() {
      ...
      this.form.items.forEach((row) => {
        ...
        if (
          ["10", "20", "30", "40", "21"].indexOf(row.affectation_igv_type_id) >
          -1
        ) {
    ...
    setDataToElectronicScaleData() {
      ...
      this.electronic_scale_data.integer_weight =
        this.electronic_scale_data.parse_weight.substring(start, end_weight);
      ...
      this.electronic_scale_data.integer_total =
        this.electronic_scale_data.parse_total.substring(start, end_total);
