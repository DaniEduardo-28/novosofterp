...
Vue.component('tenant-pos-farmacia-index', require('./views/tenant/pos_farmacia/index.vue'));
...
Vue.component('tenant-subgroup-index', require('../../modules/Item/Resources/assets/js/views/subgroup/index.vue'));
...
Vue.component('tenant-laboratory-index', require('../../modules/Digemid/Resources/assets/js/view/laboratory/index.vue'));
Vue.component('tenant-manufacturer-index', require('../../modules/Digemid/Resources/assets/js/view/manufacturer/index.vue'));
Vue.component('tenant-importer-index', require('../../modules/Digemid/Resources/assets/js/view/importer/index.vue'));
Vue.component('tenant-origin-index', require('../../modules/Digemid/Resources/assets/js/view/origin/index.vue'));
Vue.component('tenant-patient-index', require('../../modules/Digemid/Resources/assets/js/view/patients/index.vue'));
Vue.component('tenant-active_principles-index', require('../../modules/Digemid/Resources/assets/js/view/active_principles/index.vue'));
Vue.component('tenant-pharmacological_action-index', require('../../modules/Digemid/Resources/assets/js/view/pharmacological_action/index.vue'));
Vue.component('tenant-cycles-index', require('../../modules/Digemid/Resources/assets/js/view/cycles/index.vue'));
