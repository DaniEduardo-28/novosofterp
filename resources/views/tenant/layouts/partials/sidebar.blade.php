...
<aside id="sidebar-left" class="sidebar-left">
    <div class="sidebar-header">
        <a href="{{ route('tenant.dashboard.index') }}" class="logo-container">
            <img src="{{ asset('images/logo-novo-s.png') }}" alt="Logo" class="logo-image" />
            <span class="logo-title">NOVO SOFT ERP</span>
        </a>
        <div class="toggle-sidebar d-md-none" data-toggle-class="sidebar-left-opened" data-target="html"
        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                            ...
                            <ul class="nav nav-children" style="">
                                ...
                                @if (in_array('sale_notes', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'sale-notes' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.sale_notes.index') }}">Notas de
                                            Venta</a>
                                    </li>
                                @endif
                                ...
                                @if (auth()->user()->type != 'integrator' && in_array('documents', $vc_modules))
                                    ...
                                    @if (in_array('contracts', $vc_module_levels))
                                        ...
                                        {{ $firstLevel === 'production-orders' ? 'nav-active nav-expanded' : '' }}
                                            ...
                                            <ul class="nav nav-children">
                                                ...
                                                <li
                                                    class="{{ $firstLevel === 'production-orders' ? 'nav-active' : '' }}">
                                                    <a class="nav-link"
                                    ...
                                    @if (in_array('incentives', $vc_module_levels))
                                        ...
                                        {{ $firstLevel === 'user-commissions' ? 'nav-active nav-expanded' : '' }}
                                            ...
                                            <ul class="nav nav-children">
                                                <li
                                                    class="{{ $firstLevel === 'user-commissions' ? 'nav-active' : '' }}">
                                                    <a class="nav-link"
                    ...
                    {{-- DIGEMID --}}
                    @if (in_array('pharmacy', $vc_modules) && $configuration->isPharmacy())
                        <li class=" nav-parent {{ $firstLevel === 'digemid' ? 'nav-active nav-expanded' : '' }}">
                            <a class="nav-link" href="#">
                                <i class="fa fas fa-ambulance" aria-hidden="true"></i>
                                <span>Droguería/Farma</span>
                            </a>
                            <ul class="nav nav-children">
                                @if (in_array('pharmacy_pos', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'pos' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.digemid.pos') }}">Venta
                                            Rápida</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'caja' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.digemid.caja') }}">Caja Chica</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_products', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'items' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.digemid.items.index') }}">Productos</a>
                                    </li>
                                @endif
                                @if (in_array('items_packs', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'digemid' && $secondLevel === 'item-sets' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.digemid.item_sets.index') }}">Conjuntos/Packs/Promociones</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'laboratory' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.laboratory.index') }}">Laboratorio</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'manufacturer' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.manufacturer.index') }}">Fabricante</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'importer' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.importer.index') }}">Importador</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'origin' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.origin.index') }}">Procedencia</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'patient' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.patient.index') }}">Paciente</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'cycles' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.cycles.index') }}">Ciclo</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'active_principles' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.active_principles.index') }}">Principio Activo</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_caja', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'pharmacological_action' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.pharmacological_action.index') }}">Acción
                                            Farmacológica</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_products', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'products' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.digemid.products') }}">Listado de
                                            Productos</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_products', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'list' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.digemid.index') }}">Productos
                                            DIGEMID</a>
                                    </li>
                                @endif
                                @if (in_array('pharmacy_report', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'digemid' && $secondLevel === 'pharmacy_report' ? 'nav-active' : '' }}">
                                        <a class="nav-link"
                                            href="{{ route('tenant.items.export.digemid') }}">Exportar DIGEMID</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
                                ...
                                <ul class="nav nav-children">
                                    @if (in_array('pos', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'pos' && !$secondLevel ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.pos.index') }}">Punto de
                                                venta</a>
                                        </li>
                                    @endif
                                    @if (in_array('pos_garage', $vc_module_levels))
                                        <li
                                            class="{{ $firstLevel === 'pos' && $secondLevel === 'garage' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.pos.garage') }}">Venta rápida
                                                <span style="font-size:.65rem;">(Grifos y Markets)</span></a>
                                        </li>
                                    @endif
                                    @if (in_array('cash', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'cash' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.cash.index') }}">Caja chica
                                                POS</a>
                                        </li>
                                    @endif
                                </ul>
                    ...
                    @if (in_array('items', $vc_modules))
                        ...
                        {{ $firstLevel === 'categories' ? 'nav-active nav-expanded' : '' }}
                         {{ $firstLevel === 'subgroup' ? 'nav-active nav-expanded' : '' }}
                        ...
                        {{ $firstLevel === 'item-sets' ? 'nav-active nav-expanded' : '' }}
                            ...
                            <ul class="nav nav-children">
                                ...
                                @endif
                                @if (in_array('items_categories', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'subgroup' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.subgroup.index') }}">Grupos</a>
                                    </li>
                                @endif
                                ...
                                <li class="{{ $firstLevel === 'zones' ? 'nav-active' : '' }}">
                                    <a class="nav-link" href="{{ route('tenant.zone.index') }}">Zonas</a>
                                </li>
                            ...
                            <ul class="nav nav-children">
                                ...
                                @if (in_array('clients_types', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'person-types' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.person_types.index') }}">Tipos de
                                            clientes</a>
                                    </li>
                                @endif
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    @if (in_array('purchases_expenses', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'bank_loan' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.bank_loan.index') }}">Credito
                                                Bancario</a>
                                        </li>
                                    @endif
                                    @if (in_array('purchases_expenses', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'expenses' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.expenses.index') }}">Gastos
                                                diversos</a>
                                        </li>
                                    @endif
                                        ...
                                        {{ $firstLevel === 'purchase-quotations' ? 'nav-active nav-expanded' : '' }}
                                            ...
                                            <ul class="nav nav-children">
                                                @if (in_array('purchases_suppliers', $vc_module_levels))
                                                    <li
                                                        class="{{ $firstLevel === 'persons' && $secondLevel === 'suppliers' ? 'nav-active' : '' }}">
                                                        <a class="nav-link"
                                                ...
                                                @if (in_array('purchases_quotations', $vc_module_levels))
                                                    <li
                                                        class="{{ $firstLevel === 'purchase-quotations' ? 'nav-active' : '' }}">
                                                        <a class="nav-link"
                                    ...
                                    @if (in_array('purchases_fixed_assets_purchases', $vc_module_levels) ||
                                        ...
                                        <li
                                            class="nav-parent {{ $firstLevel === 'fixed-asset' ? 'nav-active nav-expanded' : '' }}">
                                ...
                                <ul class="nav nav-children">
                                    ...
                                    @if (in_array('inventory_devolutions', $vc_module_levels))
                                        <li class="{{ $firstLevel === 'devolutions' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('devolutions.index') }}">Devolucion a
                                                proveedor</a>
                                        </li>
                                    @endif
                                    @if (in_array('inventory_report_kardex', $vc_module_levels))
                                        <li
                                            ...
                                            <a class="nav-link" href="{{ route('reports.kardex.index') }}">Reporte
                                                Kardex</a>
                                        </li>
                                    @endif
                                    ...
                                    @if (in_array('production_app', $vc_modules) && $configuration->isShowExtraInfoToItem())
                                        <li class="{{ $firstLevel === 'extra_info_items' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('extra_info_items.index') }}">Datos
                                                extra de items</a>
                                        </li>
                                    @endif
                    ...
                    @if (in_array('establishments', $vc_modules))
                        <li
                            class="nav-parent {{ in_array($firstLevel, ['users', 'establishments']) ? 'nav-active nav-expanded' : '' }}">
                            <a class="nav-link" href="#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            ...
                            <ul class="nav nav-children" style="">
                                ...
                                @if (in_array('advanced_order_forms', $vc_module_levels))
                                    <li class="{{ $firstLevel === 'order-forms' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.order_forms.index') }}">Ordenes
                                            de pedido</a>
                                    </li>
                                @endif
                                <li
                                ...
                                {{ $firstLevel === 'dispatch_carrier' ? 'nav-active nav-expanded' : '' }}">
                                    ...
                                    <ul class="nav nav-children" style="">
                                        <li class="{{ $firstLevel === 'dispatches' ? 'nav-active' : '' }}">
                                            <a class="nav-link" href="{{ route('tenant.dispatches.index') }}">G.R.
                                                Remitente</a>
                                        </li>
                        ...
                        <li
                            ...
                            <ul class="nav nav-children" style="">
                                ...
                                @if (in_array('account_formats', $vc_module_levels))
                                    <li
                                        class="{{ $firstLevel === 'account' && $secondLevel == '' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('tenant.account.index') }}">Exportar
                                            formatos - Sis.
                                            Contable</a>
                                    </li>
                                @endif
                    ...
                    @if (in_array('finance', $vc_modules))
                        ...
                        <li
                            class="nav-parent {{ $firstLevel === 'finances' &&
                            ...
                            <ul class="nav nav-children">
                                @if (in_array('documentary_offices', $vc_module_levels))
                                    <li
                                        ...
                                        <a class="nav-link" href="{{ route('documentary.offices') }}">Listado de
                                            Etapas</a>
                                    </li>
                                    <li
                                        class="{{ $firstLevel === 'documentary-procedure' && $secondLevel === 'status' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('documentary.status') }}">Listado de
                                            Estados</a>
                                    </li>
                                @endif
                                @if (in_array('documentary_process', $vc_module_levels))
                                    <li
                                        ...
                                        <a class="nav-link" href="{{ route('documentary.requirements') }}">Listado
                                            de requisitos</a>
                                    </li>

                                    <li
                                        class="{{ $firstLevel === 'documentary-procedure' && $secondLevel === 'processes' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('documentary.processes') }}">Tipos de
                                            Trámites</a>
                                    </li>
                                @endif
                                {{--
                            ...
                            @endif
                                ...
                                @if (in_array('documentary_files', $vc_module_levels))
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link" href="{{ route('documentary.files_simplify') }}">Listado
                                            de Trámites</a>
                                    </li>
                                    <li
                                        class="{{ $firstLevel === 'documentary-procedure' && $secondLevel === 'stadistic' ? 'nav-active' : '' }}">
                                        <a class="nav-link" href="{{ route('documentary.stadistic') }}">Estadisticas
                                            de Trámites</a>
                                    </li>
                                @endif
                            </ul>
                    ...
                    @if (in_array('full_suscription_app', $vc_modules))
                        <li
                            class=" nav-parent {{ $firstLevel === 'full_suscription' ? 'nav-active nav-expanded' : '' }}">
                            <a class="nav-link" href="#">
                    ...
                    @if (in_array('production_app', $vc_modules))
                        <li
                            class=" nav-parent {{ $firstLevel === 'production' ||
                        ...
                        <li class=" nav-parent {{ $firstLevel === 'restaurant' ? 'nav-active nav-expanded' : '' }}">
                            ...
                            <ul class="nav nav-children">
                                ...
                                {{ ($secondLevel != null && $secondLevel == 'promotions') || ($secondLevel != null && $secondLevel == 'orders') ? 'nav-active nav-expanded' : '' }}">
                                    ...
                                    <ul class="nav nav-children">
                                        <li class="">
                                            <a class="nav-link" href="{{ route('tenant.restaurant.menu') }}"
                                                target="blank">
                                                Ver Menu
                                            </a>
                                        </li>
                    ...
                    @if (in_array('generate_link_app', $vc_modules))
                        <li class="{{ $firstLevel === 'payment-links' ? 'nav-active' : '' }}">
                            <a class="nav-link" href="{{ route('tenant.payment.generate.index') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
