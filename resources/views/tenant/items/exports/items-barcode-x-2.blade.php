...
<body>
    @if (!empty($record))
        ...
        @else
            @php
                $limitedDescription = \Illuminate\Support\Str::limit($record->description, 50);
                $colour = [0, 0, 0];
                $generator = new \Picqer\Barcode\BarcodeGeneratorPNG();
            ...
            <table width="100%" style="border: 1px solid;">
                <tr>
                    <td
                        ...
                        <p style="margin: 0; max-height: 2em; overflow: hidden; font-size: 13px;">
                            {{ $limitedDescription }}
                        </p>
                    </td>
                </tr>
            </table>
            <table width="100%" style="border: 1px solid; border-top: 0px solid !important;">
                <tr>
                    ...
                    <td rowspan="3"
                        ...
                        <h1>{{ $record->currency_type->symbol }}
                            {{ number_format($record->sale_unit_price, 2) }}</h1>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>
                            <img style="width: 200px; height: 35px;" src="data:image/png;base64,{{ $barcodeBase64 }}">
                        </p>
                    </td>
                </tr>
                <tr>
