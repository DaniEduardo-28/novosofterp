...
<body>
    ...
    <div>
        <table class="full-width">
            <tr>
                <td class="width-custom" colspan="2">
                    <p><strong>Empresa: </strong>{{ $company->name }}</p>
                </td>
            </tr>
            <tr>
                <td class="td-custom" colspan="2">
                    <p><strong>Fecha reporte: </strong>{{ date('d/m/Y') }}</p>
                </td>
            </tr>
            <tr>
                <td class="td-custom" colspan="2">
            ...
            <tr>
                ...
                <td>
                    <p><strong>{{ $cash->date_opening }} {{ $cash->time_opening }}</strong></p>
                </td>
            </tr>
            <tr>
                <td class="td-custom">
    ...
    @if ($documents->count())
        ...
        <div class="">
            <div class=" ">
                ...
                @if (!$is_garage)
                    @include('tenant.cash.partials.totals_sold_items_80')
                @endif
