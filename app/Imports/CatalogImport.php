                    ...
                    */
                    ...
                    if (!empty($item) && !empty($item->id)) {
                        ...
                        if(empty($item->laboratorio)){
                            $item->setLaboratorio($Nom_Titular)->push();
                        }
                        if(empty($item->principio_activo)){
                            $item->setPrincipioActivo($principio_activo)->push();
                        }
                        if(empty($item->concentracion)){
                            $item->setConcentracion($Concent)->push();
                        }
