...
class User extends Authenticatable
{
    ...
    */
    ...
    {
        $user = auth()->user();
        return ($user->type == 'seller') ? $query->where(
            'id',
            $user->id
        ) : null;
    }
     ...
     * @return $this
     */
    public function setModuleAndLevelModule(
        $modules = [],
        $modules_levels = []
    ) {
        $user_array = [
     ...
     */
    public function scopeGetSellers(
        $query,
    ...
    public function getDataOnlyAuthUser()
    {
        return [
            ...
            'permisosLt' => $this->permisosLt,
            'is_descuento' => $this->is_descuento
        ];
    }
