 ...
 * @property ActivePrinciple $act_principles
 * @property Laboratory $laboratory
 * @property PharmacologicalAction $pharma_action
 * @property Subgroup $subgroup
 * @property Patients $Patients
 * @property Cycles $Cycles
...
class Item extends ModelTenant
{
    ...
    public function getTemperInicialAttribute($value)
    {
        return is_null($value) ? null : round($value, 2); // Devuelve el valor con 2 decimales si no es nulo
    }

    public function setTemperInicialAttribute($value)
    {
        $this->attributes['temper_inicial'] = is_numeric($value) ? (float)$value : null; // Asigna solo si es numérico
    }

    public function getTemperFinalAttribute($value)
    {
        return is_null($value) ? null : round($value, 2);
    }

    public function setTemperFinalAttribute($value)
    {
        $this->attributes['temper_final'] = is_numeric($value) ? (float)$value : null;
    }
    ...
    /**
     * @param string $brochure_pdf
     *
     * @return Item
     */
    public function setBrochurePdf($brochure_pdf)
    {
     ...
     * @return string
     */
    public function getAnalisisPdf()
    {
        return $this->analisis_pdf;
    }

    /**
     * @param string $analisis_pdf
     *
     * @return Item
     */
    public function setAnalisisPdf($analisis_pdf)
    {
        $this->analisis_pdf = $analisis_pdf;
        return $this;
    }
     ...
     * @return string
     */
    public function getBpaPdf()
    {
        return $this->bpa_pdf;
    }

    /**
     * @param string $bpa_pdf
     *
     * @return Item
     */
    public function setBpaPdf($bpa_pdf)
    {
        $this->bpa_pdf = $bpa_pdf;
        return $this;
    }
     ...
     * @return string
     */
    public function getRegistroSanitarioPdf()
    {
        return $this->registro_sanitario_pdf;
    }

    /**
     * @param string $registro_sanitario_pdf
     *
     * @return Item
     */
    public function setRegistroSanitarioPdf($registro_sanitario_pdf)
    {
        $this->registro_sanitario_pdf = $registro_sanitario_pdf;
        return $this;
    }
     ...
     * @return BelongsTo
     */
    public function act_principles()
    {
        return $this->belongsTo(ActivePrinciples::class)->withDefault([
            'id' => '',
            'name' => ''
        ]);
    }
     ...
     * @return BelongsTo
     */
    public function pharma_action()
    {
        return $this->belongsTo(PharmacologicalAction::class)->withDefault([
            'id' => '',
            'name' => ''
        ]);
    }
    ...
    {
        return $this->belongsTo(Subgroup::class)->withDefault([
            'id' => '',
            'name' => ''
        ]);
    }
    ...
    {
        return $this->belongsTo(Patients::class)->withDefault([
            'id' => '',
            'name' => '',
            'last_name' => ''
        ]);
    ...
    {
        return $this->belongsTo(Cycles::class)->withDefault([
            'id' => '',
            'name' => ''
        ]);
    }
    ...
    public function getFullDescription($warehouse, $extended = false)
    {
        ...
        $act_principles = ($this->act_principles) ? "{$this->act_principles->name}" : '';
        $laboratory = ($this->laboratory) ? "{$this->laboratory->name}" : '';
        $pharma_action = ($this->pharma_action) ? "{$this->pharma_action->name}" : '';
        $subgroup = ($this->subgroup) ? "{$this->subgroup->name}" : '';
        $patients = ($this->patients) ? "{$this->patients->name} {$this->patients->last_name}" : '';
        $cycles = ($this->cycles) ? "{$this->cycles->name}" : '';
        ...
        return [
            ...
            'brand'                 => $brand,
            'category'              => $category,
            'act_principles'        => $act_principles,
            'laboratory'            => $laboratory,
            'pharma_action'         => $pharma_action,
            'subgroup'              => $subgroup,
            'patients'              => $patients,
            'cycles'                => $cycles,
            'customer'              => $customer,
    ...
    public function getDataToItemModal(
        ...
        $data = [
            ...
            'act_principles'                   => $detail['act_principles'],
            'laboratory'                       => $detail['laboratory'],
            'pharma_action'                    => $detail['pharma_action'],
            ...
            'accion_farmacologica' => $this->accion_farmacologica,
            'consider_temperature' => (bool) $this->consider_temperature,
            'temper_inicial' => $this->temper_inicial,
            'temper_final' => $this->temper_final,
            'brochure_pdf' => $this->brochure_pdf,
            'analisis_pdf' => $this->analisis_pdf,
            'bpa_pdf' => $this->bpa_pdf,
            'registro_sanitario_pdf' => $this->registro_sanitario_pdf,
            'controlled_product' => (bool) $this->controlled_product,
            'set_is_print' => $this->set_is_print,
            'pais' => $this->pais,
    ...
    public function getCollectionData(Configuration $configuration = null)
    {
        ...
        return [
            ...
            'patients_description' => optional($this->patients)->first_name,
            'customer_description' => optional($this->customer)->name,
            'cycles_description' => optional($this->cycles)->name,
            'act_principles_description'     => optional($this->act_principles)->name,
            'laboratory_description'            => optional($this->laboratory)->name,
            'pharma_action_description' => optional($this->pharma_action)->name,
            'subgroup_description'             => optional($this->subgroup)->name,
            'controlled_product' => (bool) $this->controlled_product,
            ...
            'is_for_production' => $this->isIsForProduction(),
            'supplies' => $itemSupply,
            'paciente' => $this->patients ? $this->patients->name : '',
            'cliente' => $this->customer ? $this->customer->name : '',
            'ciclos' => $this->cycles ? $this->cycles->name : '',
        ];
    }
    ...
    public function fillFormDigemid($data)
    {
        ...
        $this
            ...
            ->setInArray('act_principles_id', null)
            ->setInArray('laboratory_id', null)
            ->setInArray('pharma_action_id', null)
            ->setInArray('subgroup_id', null)
            ->setInArray('patients_id', null)
            ->setInArray('cycles_id', null)
            ->setInArray('customer_id', null)
    ...
    public function getReportValuedKardexCollection()
    {
        ...
        return [
            ...
            'patients_description' => optional($this->patients)->name,
            'customer_description' => optional($this->customer)->name,
            'cycles_description' => optional($this->cycles)->name,
            'unit_type_id' => $this->unit_type_id,
    ...
    public function getBarCodeData($barCodeHeight = 60)
    {
        ...
        $stocks = $this->inventory_kardex->where('quantity', '>', '0')->last()->quantity;
        $data = [];
    ...
    public function scopeActPinciples($query, $id = null)
    {
        if ($id) {
            return $query->where('act_principles_id', $id);
        }
    }
    public function scopeLaboratory($query, $id = null)
    {
        if ($id) {
            return $query->where('laboratory_id', $id);
        }
    }
    public function scopePharmaAction($query, $id = null)
    {
        if ($id) {
            return $query->where('pharma_action_id', $id);
        }
    }
    public function scopeSubgroup($query, $id = null)
    {
        if ($id) {
            return $query->where('subgroup_id', $id);
        }
    }
    public function scopePatients($query, $id = null)
    {
        if ($id) {
            return $query->where('patients_id', $id);
        }
    }
    public function scopeCustomer($query, $id = null)
    {
        if ($id) {
            return $query->where('customer_id', $id);
        }
    }
    public function scopeCycles($query, $id = null)
    {
        if ($id) {
            return $query->where('cycles_id', $id);
        }
    }
    ...
    public function getFullDescriptionAdvancedSearch()
    {
        ...
        $act_principles = "";
        if ($this->act_principles) $act_principles = ($this->act_principles->id) ? " - {$this->act_principles->name}" : "";

        $laboratory = "";
        if ($this->laboratory) $laboratory = ($this->laboratory->id) ? " - {$this->laboratory->name}" : "";

        $pharma_action = "";
        if ($this->pharma_action) $pharma_action = ($this->pharma_action->id) ? " - {$this->pharma_action->name}" : "";

        $subgroup = "";
        if ($this->subgroup) $subgroup = ($this->subgroup->id) ? " - {$this->subgroup->name}" : "";

        $patients = "";
        if ($this->patients) $patients = ($this->patients->id) ? " - {$this->patients->name} {$this->patients->last_name}" : "";

        $customer = "";
        if ($this->customer) $customer = ($this->customer->id) ? " - {$this->customer->name}" : "";

        $cycles = "";
        if ($this->cycles) $cycles = ($this->cycles->id) ? " - {$this->cycles->name}" : "";

        return "{$description}{$category}{$brand}{$act_principles}{$laboratory}{$pharma_action}{$subgroup}{$patients}{$customer}{$cycles}";
    }
    ...
    public function getApiRowResource()
    {
        ...
        return [
            ...
            'act_principles_id' => $this->act_principles_id,
            'laboratory_id' => $this->laboratory_id,
            'pharma_action_id' => $this->pharma_action_id,
