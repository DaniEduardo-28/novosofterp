...
class SaleNote extends ModelTenant
{
    ...
    public function getCollectionData(Configuration $configuration = null)
    {
        ...
        $patients = optional($this->patient)->description;
        $patients_id = optional($this->patient)->id;

        $cycles = optional($this->cycle)->description;
        $cycles_id = optional($this->cycle)->id;
