...
<body>
    ...
    @else
        <div class="company_logo_box" style="position: absolute; text-align: center; top:40%;width: 100%">
            <img src="data:{{ mime_content_type(public_path("storage/uploads/logos/{$company->logo}")) }};base64, {{ base64_encode(file_get_contents(public_path("storage/uploads/logos/{$company->logo}"))) }}"
                alt="logo" class="" style="opacity: 0.1;">
        </div>
    @endif
    ...
    <table class="full-width my-4 text-center" border="1">
        <tr>
            ...
            <td width="16.6%" class="desc">COTIZACIÓN</td>
        </tr>
        <tr>
            <td class="desc"></td>
    ...
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:11.4%;position: absolute;display: table;">
    </div>
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:49.5%;position: absolute;display: table;">
    </div>
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:57.2%;position: absolute;display: table;">
    </div>
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:64.8%;position: absolute;display: table;">
    </div>
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:76.3%;position: absolute;display: table;">
    </div>
    <div
        style="border-right: 1px solid #000;height: 48.1%;padding-left: -1px;width:83.7%;position: absolute;display: table;">
    </div>
