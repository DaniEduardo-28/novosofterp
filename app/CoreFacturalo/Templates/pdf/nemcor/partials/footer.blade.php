...
@php
    $footerq = app_path('CoreFacturalo' . DIRECTORY_SEPARATOR . 'Templates' . DIRECTORY_SEPARATOR . 'pdf' . DIRECTORY_SEPARATOR . 'nemcor' . DIRECTORY_SEPARATOR . 'footer.jpg');
@endphp
    ...
    <table class="full-width" style="top: 0%; left: 50%; transform: translate(-50%, -50%); z-index: 2;">
        ...
        <tr>
            <td style="text-align: right; padding-right: 120px;">
                <p>&nbsp;</p>
                <p>&nbsp;</p>
                <p>Av. Inca Garcilaso de la Vega N 1236, interior 316,<br>
                    distrito de Cercado de Lima, Lima.</p>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
