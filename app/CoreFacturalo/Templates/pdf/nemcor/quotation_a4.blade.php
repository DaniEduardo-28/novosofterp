@php
    ...
    $firma = app_path('CoreFacturalo' . DIRECTORY_SEPARATOR . 'Templates' . DIRECTORY_SEPARATOR . 'pdf' . DIRECTORY_SEPARATOR . 'nemcor' . DIRECTORY_SEPARATOR . 'firma.png');
@endphp
<html>
...
<body>
    ...
    <table class="full-width mt-10 mb-10">
        <thead>
            <tr style="background-color: #478538;">
