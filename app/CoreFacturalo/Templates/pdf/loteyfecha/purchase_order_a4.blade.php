        ...
        <tbody>
            @foreach ($document->items as $row)
                @php
                    ...
                    $image_url = $itemxd->image !== 'imagen-no-disponible.jpg' ? asset('storage' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'items' . DIRECTORY_SEPARATOR . $itemxd->image) : 'imagen-no-disponible.jpg';
                @endphp
                <tr>
