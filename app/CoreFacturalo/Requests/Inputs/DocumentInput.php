...
class DocumentInput
{
    public static function set($inputs)
    {
        ...
        return [
            ...
            'patients_id' => Functions::valueKeyInArray($inputs, 'patients_id'),
            'cycles_id' => Functions::valueKeyInArray($inputs, 'cycles_id'),
            ...
            foreach ($inputs['items'] as $row) {
                ...
                $arayItem = [
                    ...
                    'item' => [
                        ...
                        'is_set' => $item->is_set,
                        'lots' => self::lots($row),
                        'lots_farmacia' => self::lots_farmacia($row),
                        ...
                        'is_farmacia' => $row['item']['is_farmacia'] ?? false,
                        'used_points_for_exchange' => $row['item']['used_points_for_exchange'] ?? null,
                    ],
                    'quantity' => $row['quantity'],
                    'is_farmacia' => $row['is_farmacia'] ?? false,
...
//                dd($arayItem);
    ...
    private static function lots_farmacia($row)
    {
        if (isset($row['item']['lots_farmacia'])) {
            return $row['item']['lots_farmacia'];
        } else if (isset($row['lots_farmacia'])) {
            return $row['lots_farmacia'];
        } else {
            return [];
        }
    }
