...
class CashController extends Controller
{
    ...
    public function report_products_80($id, $is_garage = false)
    {
        ...
        $view = view('tenant.cash.report_product_pdf_80', $data)->render();
        $pdf->WriteHTML($view);

        $filename = "Reporte_POS_PRODUCTOS - {$data['cash']->user->name} - {$data['cash']->date_opening} {$data['cash']->time_opening}";

        // Establecer las cabeceras para indicar que el contenido es un PDF
