...
class DispatchController extends Controller
{
    ...
    {
        $customers = Person::orderBy('name')->take(20)->get()->transform(function ($row) {
            return [
                'id' => $row->id,
    ...
    public function create($document_id = null, $type = null, $dispatch_id = null)
    {
        ...
        foreach ($document->items as $item) {
            $name_product_pdf = ($configuration->show_pdf_name) ? $item->name_product_pdf : null;
            $items[] = [
