...
class UserController extends Controller
{
    ...
    public function tables() {
        ...
        $itemUnitTypes = ItemUnitType::where('description', '!=', null)->select('description')->distinct('description')->get();

        return compact('modules', 'establishments', 'types', 'documents', 'series', 'config_permission_to_edit_cpe','zones', 'identity_document_types', 'config_regex_password_user','itemUnitTypes');
    }
    ...
    public function store(UserRequest $request) 
    {
        ...
        DB::connection('tenant')->transaction(function () use ($request, $id) {
            ...
            $user->is_descuento = $request->input('is_descuento');
            ...
            $user->permisosLt = json_encode($request->input('permisosLt'));
            $user->save();
