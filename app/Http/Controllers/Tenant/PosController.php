...
class PosController extends Controller
{
    ...
    public function payment_tables(){
        ...
        $is_descuento = Auth::user()->is_descuento;

        return compact('series','is_descuento','payment_method_types','cards_brand', 'payment_destinations', 'global_discount_types');
    ...
    public static function FilterItem(&$item, Request $request)
    {
        ...
        if ($request->input_item && !empty($request->input_item)) {
            ...
            $whereItem[] = ['principio_activo', 'like', '%'.$request->input_item.'%'];
            $whereItem[] = ['accion_farmacologica', 'like', '%'.$request->input_item.'%'];
