    ...
    <table class="full-width mt-10 mb-10">
        <thead>
            <tr class="bg-grey">
                ...
                <th class="border-top-bottom text-center py-2 text-left" width="25%"><strong>Descripción</strong>
                </th>
                <th class="border-top-bottom text-center py-2" width="8%"><strong>UM</strong></th>
                {{-- <th class="border-top-bottom text-center py-2" width="6%"><strong>Stock mínimo</strong></th> --}}
                <th class="border-top-bottom text-center py-2" width="6%"><strong>Stock BX</strong></th>
                <th class="border-top-bottom text-center py-2" width="7%"><strong>Precio BX</strong></th>
                <th class="border-top-bottom text-center py-2" width="6%"><strong>Stock UND</strong></th>
                ...
                <th class="border-top-bottom text-center py-2" width="7%"><strong>Precio UND</strong></th>
                ...
                <th class="border-top-bottom text-center py-2 text-right" width="10%"><strong>Almacén</strong></th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            @foreach ($records as $key => $row)
                ...
                <tr>
                    ...
                    {{-- <td>{{ $row['stock_min'] }}</td> --}}
                    <td>{{ $row['stock_caja'] }}</td>
                    <td>{{ number_format($row['precio_caja'], 2, '.', '') }} </td>
