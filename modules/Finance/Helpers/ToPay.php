...
class ToPay
{
    ...
    public static function getToPay($request)
    {
        ...
        $select = DB::raw('purchases.id as id, ' .
            ...
            'persons.name as supplier_name, persons.number as supplier_number, persons.id as supplier_id, purchases.document_type_id, ' .
        ...
        $select = 'expenses.id as id, ' .
            ...
            'null as date_of_due, ' .
            'persons.name as supplier_name, persons.number as supplier_number, persons.id as supplier_id, null as document_type_id, ' .
        ...
        if ($withBankLoan === 1) {
            ...
            $select = 'bank_loans.id as id, ' .
                ...
                'null as date_of_due, ' .
                'concat(banks.description," - ",bank_accounts.description) as supplier_name, null as supplier_number,'.
