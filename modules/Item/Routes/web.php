...
if($hostname) {
    Route::domain($hostname->fqdn)->group(function () {
        Route::middleware(['auth', 'locked.tenant'])->group(function() {
            ...
            Route::get('subgroups', 'SubgroupController@index')->name('tenant.subgroup.index')->middleware('redirect.level');
            Route::get('subgroups/records', 'SubgroupController@records');
            Route::get('subgroups/tables', 'SubgroupController@tables');
            Route::get('subgroups/columns', 'SubgroupController@columns');
            Route::get('subgroups/record/{subgroup}', 'SubgroupController@record');
            Route::post('subgroups', 'SubgroupController@store');
            Route::delete('subgroups/{subgroup}', 'SubgroupController@destroy');
