            ...
            <tfoot>
              <tr>
                ...
                <td class="text-center">
                  {{ getTotal("total_transactions") }}
                </td>
                <td class="text-center">
                  {{ (getTotal("acum_sales") / 1.18).toFixed(2) }}
                </td>
                <td class="text-center">
                  {{ ((getTotal("acum_sales")) - (getTotal("acum_sales") / 1.18)).toFixed(2) }}
                </td>
                <td class="text-center">
                  {{ getTotal("acum_sales").toFixed(2) }}
                </td>
              </tr>
            </tfoot>
          </table>
...
export default {
  ...
  methods: {
    ...
    getTotal(field) {
        return this.records.reduce((total, row) => {
            let value = row[field];
            if (value == null) {
                value = 0;
