          ...
          <div class="row">
            ...
            <div class="col-sm-10 text-left mt-3 mb-0">
              <address class="ib mr-2">
                ...
                <span v-if="config.establishment.telephone != '-'">{{
                  config.establishment.telephone
                }}</span>
              </address>
            </div>
          </div>
          ...
          <div class="form-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-4">
                ...
                <p class="text-right" v-if="form.total_taxed > 0">
                ...
                <h3 class="text-right" v-if="form.total > 0">
                  <b>TOTAL A PAGAR: </b>{{ currency_type.symbol }}
                  {{ form.total }}
                </h3>
              </div>
            </div>
...
import DeliveryAddressForm from "./partials/DeliveryAddressFormPedido.vue";
...
export default {
  ...
  methods: {
    ...
    async successDeliveryAddress(address) {
    ...
    ...mapActions(["loadConfiguration", "loadCompany", "loadEstablishment"]),
    ...
    setDescriptionOfItem(item) {
      return showNamePdfOfDescription(item, true);
    },
