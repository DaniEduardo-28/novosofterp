<template>
  <div>
    ...
    <div class="card mb-0">
      ...
      <div class="card-body">
        ...
        >
          <tr slot="heading">
            ...
            <th class="text-center" v-if="columns.delivery_date.visible">
              Fecha Entrega
            </th>
            <th>Vendedor</th>
            <th>Cliente</th>
          ...
          >
            ...
            <td v-if="columns.mi_tienda_pe.visible">
              <!-- Codigo mi tienda -->
              <template
                v-if="row.mi_tienda_pe && row.mi_tienda_pe.order_number"
              >
      ...
      <mi-tienda-pe :showDialog.sync="showMiTiendaPeDialog"></mi-tienda-pe>
    </div>
  </div>
</template>
<style scoped>
  ...
  methods: {
    ...
    canAnulate(row) {
      if (row && row.documents) {
        if (row.documents.length == 0 && row.state_type_id != "11") return true;
